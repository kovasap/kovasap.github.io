...
var vec__9496 = axis;
var a_x = cljs.core.nth.call(null,vec__9496,(0),null);
var a_y = cljs.core.nth.call(null,vec__9496,(1),null);
var a_z = cljs.core.nth.call(null,vec__9496,(2),null);
var vec__9499 = v;
var x = cljs.core.nth.call(null,vec__9499,(0),null);
var y = cljs.core.nth.call(null,vec__9499,(1),null);
var z = cljs.core.nth.call(null,vec__9499,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__9502,p__9503){
var vec__9504 = p__9502;
var u1 = cljs.core.nth.call(null,vec__9504,(0),null);
var u2 = cljs.core.nth.call(null,vec__9504,(1),null);
var u3 = cljs.core.nth.call(null,vec__9504,(2),null);
var vec__9507 = p__9503;
var v1 = cljs.core.nth.call(null,vec__9507,(0),null);
var v2 = cljs.core.nth.call(null,vec__9507,(1),null);
var v3 = cljs.core.nth.call(null,vec__9507,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__9510_SHARP_){
return (p1__9510_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__9511_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__9512_SHARP_,angle_lr),angle_ud);
...
var map__9514 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__9514__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__9514__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5718__auto__ = (function (){var pred__9516 = cljs.core._EQ_;
var expr__9517 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__9516.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__9517))){
return straight;
} else {
if(cljs.core.truth_(pred__9516.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__9517))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__9516.call(null,quil.middlewares.navigation_3d.space,expr__9517))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__9516.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__9517))){
return up;
} else {
if(cljs.core.truth_(pred__9516.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__9517))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__9516.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__9517))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5718__auto__,map__9514,map__9514__$1,up,straight){
return (function (p1__9513_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__9513_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5718__auto__,map__9514,map__9514__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__9519_SHARP_);
});})(initial_state))
);
});
/**
...
var map__9520_9531 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__9520_9532__$1 = ((((!((map__9520_9531 == null)))?(((((map__9520_9531.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9520_9531.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9520_9531):map__9520_9531);
var vec__9521_9533 = cljs.core.get.call(null,map__9520_9532__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_9534 = cljs.core.nth.call(null,vec__9521_9533,(0),null);
var c_y_9535 = cljs.core.nth.call(null,vec__9521_9533,(1),null);
var c_z_9536 = cljs.core.nth.call(null,vec__9521_9533,(2),null);
var vec__9524_9537 = cljs.core.get.call(null,map__9520_9532__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_9538 = cljs.core.nth.call(null,vec__9524_9537,(0),null);
var u_y_9539 = cljs.core.nth.call(null,vec__9524_9537,(1),null);
var u_z_9540 = cljs.core.nth.call(null,vec__9524_9537,(2),null);
var vec__9527_9541 = cljs.core.get.call(null,map__9520_9532__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_9542 = cljs.core.nth.call(null,vec__9527_9541,(0),null);
var p_y_9543 = cljs.core.nth.call(null,vec__9527_9541,(1),null);
var p_z_9544 = cljs.core.nth.call(null,vec__9527_9541,(2),null);
quil.core.camera.call(null,p_x_9542,p_y_9543,p_z_9544,(p_x_9542 + c_x_9534),(p_y_9543 + c_y_9535),(p_z_9544 + c_z_9536),u_x_9538,u_y_9539,u_z_9540);
