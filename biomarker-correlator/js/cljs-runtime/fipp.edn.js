...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__63526,open,xs,sep,close,f){
var map__63527 = p__63526;
var map__63527__$1 = cljs.core.__destructure_map(map__63527);
var printer = map__63527__$1;
var print_level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63527__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63527__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__63528 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__63528,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__63528;
}
})();
var xform = cljs.core.comp.cljs$core$IFn$_invoke$arity$3((cljs.core.truth_(print_length)?cljs.core.take.cljs$core$IFn$_invoke$arity$1(print_length):cljs.core.identity),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__63525_SHARP_){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(printer__$1,p1__63525_SHARP_) : f.call(null,printer__$1,p1__63525_SHARP_));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k63533,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k63533,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__63557){
var vec__63558 = p__63557;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63558,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63558,(1),null);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__63532){
var self__ = this;
var G__63532__$1 = this;
return (new cljs.core.RecordIter((0),G__63532__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var self__ = this;
var this$__$1 = this;
var _STAR_print_dup_STAR__orig_val__63570 = cljs.core._STAR_print_dup_STAR_;
var _STAR_print_dup_STAR__temp_val__63571 = false;
(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__temp_val__63571);
...
}finally {(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__orig_val__63570);
}}));
...
var self__ = this;
var this$__$1 = this;
var temp__5751__auto__ = (function (){var G__63577 = cljs.core.first(x);
return (self__.symbols.cljs$core$IFn$_invoke$arity$1 ? self__.symbols.cljs$core$IFn$_invoke$arity$1(G__63577) : self__.symbols.call(null,G__63577));
})();
...
(fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__63580){
var self__ = this;
var map__63581 = p__63580;
var map__63581__$1 = cljs.core.__destructure_map(map__63581);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63581__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63581__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
var self__ = this;
var this$__$1 = this;
return fipp.edn.pretty_coll(this$__$1,"{",x,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),",",new cljs.core.Keyword(null,"line","line",212345235)], null),"}",(function (printer,p__63586){
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__63594 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__63595 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__63595);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__63594);
}})()], null);
}));
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__63596 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__63597 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__63597);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__63596);
}})()], null);
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this63534,other63535){
var self__ = this;
var this63534__$1 = this;
return (((!((other63535 == null)))) && ((((this63534__$1.constructor === other63535.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63534__$1.symbols,other63535.symbols)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63534__$1.print_meta,other63535.print_meta)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63534__$1.print_length,other63535.print_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63534__$1.print_level,other63535.print_level)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63534__$1.__extmap,other63535.__extmap)))))))))))));
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k63533){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k63533);

}
}));

(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__63532){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__63599 = cljs.core.keyword_identical_QMARK_;
var expr__63600 = k__4511__auto__;
if(cljs.core.truth_((pred__63599.cljs$core$IFn$_invoke$arity$2 ? pred__63599.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__63600) : pred__63599.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__63600)))){
return (new fipp.edn.EdnPrinter(G__63532,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__63599.cljs$core$IFn$_invoke$arity$2 ? pred__63599.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__63600) : pred__63599.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__63600)))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__63532,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__63599.cljs$core$IFn$_invoke$arity$2 ? pred__63599.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__63600) : pred__63599.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__63600)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__63532,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__63599.cljs$core$IFn$_invoke$arity$2 ? pred__63599.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__63600) : pred__63599.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__63600)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__63532,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__63532),null));
}
}
}
}
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__63532){
var self__ = this;
var this__4501__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__63532,self__.__extmap,self__.__hash));
}));
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__63539){
var extmap__4542__auto__ = (function (){var G__63602 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__63539,new cljs.core.Keyword(null,"symbols","symbols",1211743),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], 0));
if(cljs.core.record_QMARK_(G__63539)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__63602);
} else {
return G__63602;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__63539),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__63539),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__63539),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__63539),null,cljs.core.not_empty(extmap__4542__auto__),null));
});

fipp.edn.pretty = (function fipp$edn$pretty(var_args){
var G__63604 = arguments.length;
switch (G__63604) {
case 1:
...
var _STAR_print_meta_STAR__orig_val__63605 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__63606 = false;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__63606);

try{return fipp.visit.visit(printer,x);
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__63605);
}}));
