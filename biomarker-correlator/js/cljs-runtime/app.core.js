...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57314_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__57314_SHARP_,new cljs.core.Keyword(null,"date","date",-1463434462));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.sorted_map_by(cljs.core._LT_),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57315_SHARP_){
return ((cljs.core.vector_QMARK_(p1__57315_SHARP_)) && ((!(cljs.core.map_QMARK_(cljs.core.last(p1__57315_SHARP_))))));
}),cljs.core.tree_seq(cljs.core.associative_QMARK_,cljs.core.seq,data)));
});
app.core.home_page = (function app$core$home_page(){
var map__57317 = cljs.core.deref(app.csv.csv_data);
var map__57317__$1 = cljs.core.__destructure_map(map__57317);
var input_file_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57317__$1,new cljs.core.Keyword(null,"input-file-name","input-file-name",-1886577211));
var biomarker_file_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57317__$1,new cljs.core.Keyword(null,"biomarker-file-name","biomarker-file-name",1322694478));
var input_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57317__$1,new cljs.core.Keyword(null,"input-data","input-data",2052925403));
var biomarker_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57317__$1,new cljs.core.Keyword(null,"biomarker-data","biomarker-data",-1785875135));
...
var pairwise_correlations_for_table = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57316_SHARP_){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$5(p1__57316_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"regression-results","regression-results",224318376)], null),cljs.core.dissoc,new cljs.core.Keyword(null,"scatterplot","scatterplot",2135008985),new cljs.core.Keyword(null,"raw-data","raw-data",617791828));
...
var c__4650__auto__ = cljs.core.chunk_first(s__57319__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__57321 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__57320 = (0);
while(true){
if((i__57320 < size__4651__auto__)){
var sig_correlations = cljs.core._nth(c__4650__auto__,i__57320);
cljs.core.chunk_append(b__57321,app.single_var_table.make_hiccup(sig_correlations));

var G__57338 = (i__57320 + (1));
i__57320 = G__57338;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57321),app$core$home_page_$_iter__57318(cljs.core.chunk_rest(s__57319__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57321),null);
}
} else {
var sig_correlations = cljs.core.first(s__57319__$2);
return cljs.core.cons(app.single_var_table.make_hiccup(sig_correlations),app$core$home_page_$_iter__57318(cljs.core.rest(s__57319__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57325),app$core$home_page_$_iter__57322(cljs.core.chunk_rest(s__57323__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57325),null);
}
} else {
var sig_correlations = cljs.core.first(s__57323__$2);
return cljs.core.cons(app.single_var_table.make_hiccup(sig_correlations),app$core$home_page_$_iter__57322(cljs.core.rest(s__57323__$2)));
}
} else {
return null;
}
