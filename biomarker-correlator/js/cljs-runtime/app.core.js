...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57798_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__57798_SHARP_,new cljs.core.Keyword(null,"date","date",-1463434462));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.sorted_map_by(cljs.core._LT_),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57803_SHARP_){
return ((cljs.core.vector_QMARK_(p1__57803_SHARP_)) && ((!(cljs.core.map_QMARK_(cljs.core.last(p1__57803_SHARP_))))));
}),cljs.core.tree_seq(cljs.core.associative_QMARK_,cljs.core.seq,data)));
});
app.core.home_page = (function app$core$home_page(){
var map__57806 = cljs.core.deref(app.csv.csv_data);
var map__57806__$1 = cljs.core.__destructure_map(map__57806);
var input_file_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57806__$1,new cljs.core.Keyword(null,"input-file-name","input-file-name",-1886577211));
var biomarker_file_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57806__$1,new cljs.core.Keyword(null,"biomarker-file-name","biomarker-file-name",1322694478));
var input_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57806__$1,new cljs.core.Keyword(null,"input-data","input-data",2052925403));
var biomarker_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57806__$1,new cljs.core.Keyword(null,"biomarker-data","biomarker-data",-1785875135));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57811),app$core$home_page_$_iter__57808(cljs.core.chunk_rest(s__57809__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57811),null);
}
} else {
var sig_correlations = cljs.core.first(s__57809__$2);
return cljs.core.cons(app.single_var_table.make_hiccup(sig_correlations),app$core$home_page_$_iter__57808(cljs.core.rest(s__57809__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57817),app$core$home_page_$_iter__57814(cljs.core.chunk_rest(s__57815__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57817),null);
}
} else {
var sig_correlations = cljs.core.first(s__57815__$2);
return cljs.core.cons(app.single_var_table.make_hiccup(sig_correlations),app$core$home_page_$_iter__57814(cljs.core.rest(s__57815__$2)));
}
} else {
return null;
}
