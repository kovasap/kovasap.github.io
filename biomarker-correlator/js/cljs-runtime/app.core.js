...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53819_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__53819_SHARP_,new cljs.core.Keyword(null,"date","date",-1463434462));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.sorted_map_by(cljs.core._LT_),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53820_SHARP_){
return ((cljs.core.vector_QMARK_(p1__53820_SHARP_)) && ((!(cljs.core.map_QMARK_(cljs.core.last(p1__53820_SHARP_))))));
}),cljs.core.tree_seq(cljs.core.associative_QMARK_,cljs.core.seq,data)));
});
app.core.home_page = (function app$core$home_page(){
var map__53822 = cljs.core.deref(app.csv.csv_data);
var map__53822__$1 = cljs.core.__destructure_map(map__53822);
var input_file_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53822__$1,new cljs.core.Keyword(null,"input-file-name","input-file-name",-1886577211));
var biomarker_file_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53822__$1,new cljs.core.Keyword(null,"biomarker-file-name","biomarker-file-name",1322694478));
var input_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53822__$1,new cljs.core.Keyword(null,"input-data","input-data",2052925403));
var biomarker_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53822__$1,new cljs.core.Keyword(null,"biomarker-data","biomarker-data",-1785875135));
...
var pairwise_correlations_for_table = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53821_SHARP_){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$5(p1__53821_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"regression-results","regression-results",224318376)], null),cljs.core.dissoc,new cljs.core.Keyword(null,"scatterplot","scatterplot",2135008985),new cljs.core.Keyword(null,"raw-data","raw-data",617791828));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53828),app$core$home_page_$_iter__53825(cljs.core.chunk_rest(s__53826__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53828),null);
}
} else {
var sig_correlations = cljs.core.first(s__53826__$2);
return cljs.core.cons(app.single_var_table.make_hiccup(sig_correlations),app$core$home_page_$_iter__53825(cljs.core.rest(s__53826__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53832),app$core$home_page_$_iter__53829(cljs.core.chunk_rest(s__53830__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53832),null);
}
} else {
var sig_correlations = cljs.core.first(s__53830__$2);
return cljs.core.cons(app.single_var_table.make_hiccup(sig_correlations),app$core$home_page_$_iter__53829(cljs.core.rest(s__53830__$2)));
}
} else {
return null;
}
