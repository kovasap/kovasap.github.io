...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_41843 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_41843(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_41846 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_41846(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_41847 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_41847(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_41848 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_41848(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_41849 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_41849(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_41850 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_41850(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__41837,callback){
var map__41838 = p__41837;
var map__41838__$1 = cljs.core.__destructure_map(map__41838);
var input = map__41838__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41838__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41838__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
