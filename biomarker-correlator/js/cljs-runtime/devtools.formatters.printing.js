...
var len__4864__auto___72026 = arguments.length;
var i__4865__auto___72027 = (0);
while(true){
if((i__4865__auto___72027 < len__4864__auto___72026)){
args__4870__auto__.push((arguments[i__4865__auto___72027]));

var G__72029 = (i__4865__auto___72027 + (1));
i__4865__auto___72027 = G__72029;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq71898){
var G__71899 = cljs.core.first(seq71898);
var seq71898__$1 = cljs.core.next(seq71898);
var G__71900 = cljs.core.first(seq71898__$1);
var seq71898__$2 = cljs.core.next(seq71898__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71899,G__71900,seq71898__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__71911_SHARP_){
return (!((cljs.core.meta(p1__71911_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71982__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e71985){var _e__34431__auto__ = e71985;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e71989){var _e__34431__auto__ = e71989;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__71995 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__71996 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__71996);
...
var map__71997 = opts;
var map__71997__$1 = cljs.core.__destructure_map(map__71997);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71997__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__71995);
}});
...
var temp__5751__auto___72046 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___72046)){
var managed_print_level_72047 = temp__5751__auto___72046;
var _STAR_print_level_STAR__orig_val__72006_72048 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__72007_72049 = managed_print_level_72047;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__72007_72049);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__71999_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__71999_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__72006_72048);
}} else {
job_fn();
}
