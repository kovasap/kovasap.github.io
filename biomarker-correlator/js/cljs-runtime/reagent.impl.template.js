...
var G__80073 = o;
reagent.impl.template.goog$module$goog$object.set(G__80073,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__80228__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__80228 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__80229__i = 0, G__80229__a = new Array(arguments.length -  0);
while (G__80229__i < G__80229__a.length) {G__80229__a[G__80229__i] = arguments[G__80229__i + 0]; ++G__80229__i;}
  args = new cljs.core.IndexedSeq(G__80229__a,0,null);
} 
return G__80228__delegate.call(this,args);};
G__80228.cljs$lang$maxFixedArity = 0;
G__80228.cljs$lang$applyTo = (function (arglist__80230){
var args = cljs.core.seq(arglist__80230);
return G__80228__delegate(args);
});
...
var G__80086 = o;
reagent.impl.template.goog$module$goog$object.set(G__80086,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__80232__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__80232 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__80233__i = 0, G__80233__a = new Array(arguments.length -  0);
while (G__80233__i < G__80233__a.length) {G__80233__a[G__80233__i] = arguments[G__80233__i + 0]; ++G__80233__i;}
  args = new cljs.core.IndexedSeq(G__80233__a,0,null);
} 
return G__80232__delegate.call(this,args);};
G__80232.cljs$lang$maxFixedArity = 0;
G__80232.cljs$lang$applyTo = (function (arglist__80234){
var args = cljs.core.seq(arglist__80234);
return G__80232__delegate(args);
});
...
var G__80092 = props;
var G__80092__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__80092,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__80092);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__80092__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__80095 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__80095,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__80095;
}
})(),id_class);
...
var G__80106 = (cljs.core.count(argv) - first_child);
switch (G__80106) {
case (0):
...
var vec__80118 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80118,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80118,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80118,(2),null);
...
var temp__5757__auto___80239 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___80239 == null)){
} else {
var key_80240 = temp__5757__auto___80239;
(jsprops.key = key_80240);
}
...
var temp__5757__auto___80242 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___80242 == null)){
} else {
var key_80243 = temp__5757__auto___80242;
(jsprops.key = key_80243);
}
...
var temp__5757__auto___80244 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___80244 == null)){
} else {
var key_80245 = temp__5757__auto___80244;
(jsprops.key = key_80245);
}
...
var temp__5757__auto___80250 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___80250 == null)){
} else {
var key_80251 = temp__5757__auto___80250;
(jsprops.key = key_80251);
}
...
var temp__5757__auto___80254 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___80254 == null)){
} else {
var key_80255 = temp__5757__auto___80254;
(jsprops.key = key_80255);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80149_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__80149_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__80161 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80161,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80161,(1),null);
...
break;
default:
var G__80263 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__80264 = compiler;
v = G__80263;
compiler = G__80264;
continue;
...
var G__80185 = tag;
var G__80185__$1 = (((G__80185 instanceof cljs.core.Keyword))?G__80185.fqn:null);
switch (G__80185__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template80203 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template80203 = (function (opts,id,fn_to_element,parse_fn,meta80204){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template80203.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_80205,meta80204__$1){
var self__ = this;
var _80205__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template80203(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta80204__$1));
}));

(reagent.impl.template.t_reagent$impl$template80203.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_80205){
var self__ = this;
var _80205__$1 = this;
return self__.meta80204;
}));

(reagent.impl.template.t_reagent$impl$template80203.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template80203.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template80203.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template80203.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template80203.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template80203.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta80204","meta80204",-438080990,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template80203.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template80203.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template80203");

(reagent.impl.template.t_reagent$impl$template80203.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template80203");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template80203.
 */
reagent.impl.template.__GT_t_reagent$impl$template80203 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template80203(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta80204){
return (new reagent.impl.template.t_reagent$impl$template80203(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta80204));
});

}

return (new reagent.impl.template.t_reagent$impl$template80203(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
