...
cljs.core.chunk_append(b__40757,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.comparison_matrix_table._build__key(m,cljs.core.name(k)),v], null));

var G__40805 = (i__40756 + (1));
i__40756 = G__40805;
continue;
} else {
var G__40806 = (i__40756 + (1));
i__40756 = G__40806;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40757),app$comparison_matrix_table$get_flat_biomarker_result_keys_$_iter__40754(cljs.core.chunk_rest(s__40755__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40757),null);
}
} else {
var vec__40767 = cljs.core.first(s__40755__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40767,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40767,(1),null);
if(cljs.core.truth_((filter_func.cljs$core$IFn$_invoke$arity$1 ? filter_func.cljs$core$IFn$_invoke$arity$1(k) : filter_func.call(null,k)))){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.comparison_matrix_table._build__key(m,cljs.core.name(k)),v], null),app$comparison_matrix_table$get_flat_biomarker_result_keys_$_iter__40754(cljs.core.rest(s__40755__$2)));
} else {
var G__40807 = cljs.core.rest(s__40755__$2);
s__40755__$1 = G__40807;
continue;
}
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([flat_map,new cljs.core.Keyword(null,"aggregates","aggregates",-1684250289).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__40787 = new cljs.core.Keyword(null,"input","input",556931961).cljs$core$IFn$_invoke$arity$1(flat_map);
return (fexpr__40787.cljs$core$IFn$_invoke$arity$1 ? fexpr__40787.cljs$core$IFn$_invoke$arity$1(input_significant_correlations) : fexpr__40787.call(null,input_significant_correlations));
})())], 0));
});
/**
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40791_SHARP_){
return (!((p1__40791_SHARP_ == null)));
...
var p_value_filter = (function (p1__40801_SHARP_){
if(cljs.core.truth_(cljs.core.deref(p_values_rounded_QMARK_))){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40801_SHARP_,new cljs.core.Keyword(null,"p-value","p-value",1434023819));
} else {
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40801_SHARP_,new cljs.core.Keyword(null,"rounded-p-value","rounded-p-value",1372746415));
}
});
...
var vec__40802 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/\-\-/);
var biomarker = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40802,(0),null);
var stat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40802,(1),null);
