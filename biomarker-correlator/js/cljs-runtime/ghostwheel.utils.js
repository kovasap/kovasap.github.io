...
var _STAR_config_cache_52467 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516),(0),new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378),null], null));
var read_config_file_52468 = (function (){
return null;
});
var reload_config_52469 = (function (){
var plain_config = (function (){var cljs_compiler_config = (cljs.core.truth_(cljs.env._STAR_compiler_STAR_)?(function (){var or__4253__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(cljs.env._STAR_compiler_STAR_),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"external-config","external-config",-471423941),new cljs.core.Keyword(null,"ghostwheel","ghostwheel",1311459564)], null));
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.PersistentArrayMap.EMPTY,read_config_file_52468(),cljs_compiler_config], 0));
} else {
return null;
}
})();
if(cljs.core.truth_(plain_config)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52422){
...
ghostwheel.utils.get_env_config = (function ghostwheel$utils$get_env_config(var_args){
...
(ghostwheel.utils.get_env_config.cljs$core$IFn$_invoke$arity$0 = (function (){
return ghostwheel.utils.get_env_config.cljs$core$IFn$_invoke$arity$1(true);
}));

(ghostwheel.utils.get_env_config.cljs$core$IFn$_invoke$arity$1 = (function (cache_QMARK_){
if(cljs.core.not(cache_QMARK_)){
return reload_config_52469();
} else {
var now = cljs.core.identity(Date.now());
if(((now - new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_config_cache_52467))) < (2000))){
return new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_config_cache_52467));
} else {
return new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378).cljs$core$IFn$_invoke$arity$1(cljs.core.reset_BANG_(_STAR_config_cache_52467,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516),now,new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378),reload_config_52469()], null)));
}
}
}));
...
var ns_replacements = (function (){var G__52455 = new cljs.core.PersistentArrayMap(null, 6, ["clojure.core","cljs.core","clojure.test","cljs.test","clojure.spec.alpha","cljs.spec.alpha","clojure.spec.test.alpha","cljs.spec.test.alpha","orchestra.spec.test","orchestra-cljs.spec.test","clojure.spec.gen.alpha","cljs.spec.gen.alpha"], null);
if(cljs.core.truth_(strip_core_ns)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__52455,new cljs.core.PersistentArrayMap(null, 2, ["clojure.core",null,"cljs.core",null], null)], 0));
} else {
return G__52455;
}
})();
var replace_namespace = (function (p1__52447_SHARP_){
if((!(cljs.core.qualified_symbol_QMARK_(p1__52447_SHARP_)))){
return p1__52447_SHARP_;
} else {
var nspace = cljs.core.namespace(p1__52447_SHARP_);
if(cljs.core.contains_QMARK_(ns_replacements,nspace)){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(ns_replacements,nspace),cljs.core.name(p1__52447_SHARP_));
} else {
return p1__52447_SHARP_;
}
}
