...
app.time.map_to_timestamp = (function app$time$map_to_timestamp(p__48850){
var map__48851 = p__48850;
var map__48851__$1 = cljs.core.__destructure_map(map__48851);
var month = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48851__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48851__$1,new cljs.core.Keyword(null,"date","date",-1463434462));
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48851__$1,new cljs.core.Keyword(null,"year","year",335913393));
...
var vec__48852 = split;
var month = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48852,(0),null);
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48852,(1),null);
var year = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48852,(2),null);
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"month","month",-1960248533),(month | (0)),new cljs.core.Keyword(null,"date","date",-1463434462),(day | (0)),new cljs.core.Keyword(null,"year","year",335913393),((function (){var G__48855 = cljs.core.count(year);
switch (G__48855) {
case (2):
...
var vec__48856 = split_date;
var date1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48856,(0),null);
var date2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48856,(1),null);
...
var G__48859 = period_type;
var G__48859__$1 = (((G__48859 instanceof cljs.core.Keyword))?G__48859.fqn:null);
switch (G__48859__$1) {
case "none":
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(timestamp);
...
return cljs.core.group_by((function (p1__48860_SHARP_){
return app.time.get_period_id(new cljs.core.Keyword(null,"timestamp","timestamp",579478971).cljs$core$IFn$_invoke$arity$1(p1__48860_SHARP_),period_type);
}),data);
});
