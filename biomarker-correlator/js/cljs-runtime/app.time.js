...
app.time.map_to_timestamp = (function app$time$map_to_timestamp(p__48316){
var map__48317 = p__48316;
var map__48317__$1 = cljs.core.__destructure_map(map__48317);
var month = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48317__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48317__$1,new cljs.core.Keyword(null,"date","date",-1463434462));
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48317__$1,new cljs.core.Keyword(null,"year","year",335913393));
...
var vec__48318 = split;
var month = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48318,(0),null);
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48318,(1),null);
var year = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48318,(2),null);
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"month","month",-1960248533),(month | (0)),new cljs.core.Keyword(null,"date","date",-1463434462),(day | (0)),new cljs.core.Keyword(null,"year","year",335913393),((function (){var G__48321 = cljs.core.count(year);
switch (G__48321) {
case (2):
...
var vec__48322 = split_date;
var date1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48322,(0),null);
var date2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48322,(1),null);
...
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48326_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs_time.coerce.from_long,app.time.get_period_range(new cljs.core.Keyword(null,"timestamp","timestamp",579478971).cljs$core$IFn$_invoke$arity$1(p1__48326_SHARP_),period_type));
}),data)], 0));

return cljs.core.group_by((function (p1__48327_SHARP_){
return app.time.get_period_range(new cljs.core.Keyword(null,"timestamp","timestamp",579478971).cljs$core$IFn$_invoke$arity$1(p1__48327_SHARP_),period_type);
}),data);
});
