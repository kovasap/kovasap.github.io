...
app.time.map_to_timestamp = (function app$time$map_to_timestamp(p__47714){
var map__47715 = p__47714;
var map__47715__$1 = cljs.core.__destructure_map(map__47715);
var month = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47715__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47715__$1,new cljs.core.Keyword(null,"date","date",-1463434462));
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47715__$1,new cljs.core.Keyword(null,"year","year",335913393));
...
var vec__47716 = split;
var month = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47716,(0),null);
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47716,(1),null);
var year = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47716,(2),null);
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"month","month",-1960248533),(month | (0)),new cljs.core.Keyword(null,"date","date",-1463434462),(day | (0)),new cljs.core.Keyword(null,"year","year",335913393),((function (){var G__47719 = cljs.core.count(year);
switch (G__47719) {
case (2):
...
var vec__47722 = split_date;
var date1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47722,(0),null);
var date2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47722,(1),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47732__$1)].join('')));

}
});
app.time.group_by_period = (function app$time$group_by_period(data,period_type){
return cljs.core.group_by((function (p1__47734_SHARP_){
return app.time.get_period_range(new cljs.core.Keyword(null,"timestamp","timestamp",579478971).cljs$core$IFn$_invoke$arity$1(p1__47734_SHARP_),period_type);
}),data);
});
