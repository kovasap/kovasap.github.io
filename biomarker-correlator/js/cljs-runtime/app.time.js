...
var vec__52254 = split;
var month = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52254,(0),null);
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52254,(1),null);
var year = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52254,(2),null);
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"month","month",-1960248533),(month | (0)),new cljs.core.Keyword(null,"date","date",-1463434462),(day | (0)),new cljs.core.Keyword(null,"year","year",335913393),((function (){var G__52257 = cljs.core.count(year);
switch (G__52257) {
case (2):
...
app.time.map_to_timestamp = (function app$time$map_to_timestamp(p__52258){
var map__52259 = p__52258;
var map__52259__$1 = cljs.core.__destructure_map(map__52259);
var month = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52259__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52259__$1,new cljs.core.Keyword(null,"date","date",-1463434462));
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52259__$1,new cljs.core.Keyword(null,"year","year",335913393));
...
var vec__52261 = split_date;
var date1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52261,(0),null);
var date2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52261,(1),null);
