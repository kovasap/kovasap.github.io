...
var sablono$util$ToString$to_str$dyn_27201 = (function (x){
...
return sablono$util$ToString$to_str$dyn_27201(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_27204 = (function (x){
var x__5393__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_27204(x);
}
});
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq27144){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27144));
}));
...
var vec__27152 = cljs.core.name(k).split("-");
...
var first_word = first__27154;
var words = seq__27153__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__27156){
var vec__27157 = p__27156;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27157,(0),null);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27163,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__27163;
}
} else {
