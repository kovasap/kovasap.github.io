...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38686 = c;
var G__38686__$1 = (((G__38686 == null))?null:G__38686.prototype);
if((G__38686__$1 == null)){
return null;
} else {
return G__38686__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38689 = c;
var G__38689__$1 = (((G__38689 == null))?null:G__38689.prototype);
if((G__38689__$1 == null)){
return null;
} else {
return G__38689__$1.render;
}
})() == null)))));
});
...
while (G__38891__i < G__38891__a.length) {G__38891__a[G__38891__i] = arguments[G__38891__i + 0]; ++G__38891__i;}
  args = new cljs.core.IndexedSeq(G__38891__a,0,null);
} 
...
var args = cljs.core.seq(arglist__38892);
...
var or__5045__auto__ = (function (){var G__38712 = c;
var G__38712__$1 = (((G__38712 == null))?null:G__38712.constructor);
if((G__38712__$1 == null)){
return null;
} else {
return G__38712__$1.displayName;
}
})();
...
var G__38723 = c;
var G__38723__$1 = (((G__38723 == null))?null:G__38723.constructor);
if((G__38723__$1 == null)){
return null;
} else {
return G__38723__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38732 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38733 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38733);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38732);
}});
...
var c = this;
var G__38757_38902 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__38757_38902 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38757_38902);
}
...
var renders_38911 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38912 = cljs.core.first(cljs.core.vals(renders_38911));
...
if((cljs.core.count(renders_38911) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38911))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38912)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38912], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
G__38929.cljs$lang$applyTo = (function (arglist__38933){
var args = cljs.core.seq(arglist__38933);
...
var _STAR_current_component_STAR__orig_val__38852 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38853 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38853);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38852);
}});
...
var vec__38855 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38855,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38855,(1),null);
...
var G__38859 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__38859 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38859);
}
});
}),[]);
