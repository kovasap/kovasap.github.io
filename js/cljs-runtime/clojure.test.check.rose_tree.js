...
return cljs.core.cons(cljs.core.first(s),(function (){var G__42712 = (n - (1));
var G__42713 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__42712,G__42713) : clojure.test.check.rose_tree.exclude_nth.call(null,G__42712,G__42713));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__42721 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__42721) : f.call(null,G__42721));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42720_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__42720_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__42720_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42747_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__42747_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__42747_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__42752_SHARP_){
var G__42772 = clojure.test.check.rose_tree.root(p1__42752_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__42772) : pred.call(null,G__42772));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5523__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__42782(s__42783){
return (new cljs.core.LazySeq(null,(function (){
var s__42783__$1 = s__42783;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__42783__$1);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var vec__42789 = cljs.core.first(xs__6360__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42789,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42789,(1),null);
var iterys__5519__auto__ = ((function (s__42783__$1,vec__42789,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__42782_$_iter__42784(s__42785){
return (new cljs.core.LazySeq(null,((function (s__42783__$1,vec__42789,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function (){
var s__42785__$1 = s__42785;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__42785__$1);
if(temp__5804__auto____$1){
var s__42785__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__42785__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__42785__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__42787 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__42786 = (0);
while(true){
if((i__42786 < size__5522__auto__)){
var child = cljs.core._nth(c__5521__auto__,i__42786);
cljs.core.chunk_append(b__42787,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__42829 = (i__42786 + (1));
i__42786 = G__42829;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42787),clojure$test$check$rose_tree$permutations_$_iter__42782_$_iter__42784(cljs.core.chunk_rest(s__42785__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42787),null);
}
} else {
var child = cljs.core.first(s__42785__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__42782_$_iter__42784(cljs.core.rest(s__42785__$2)));
}
} else {
return null;
}
...
});})(s__42783__$1,vec__42789,rose,index,xs__6360__auto__,temp__5804__auto__))
,null,null));
});})(s__42783__$1,vec__42789,rose,index,xs__6360__auto__,temp__5804__auto__))
;
var fs__5520__auto__ = cljs.core.seq(iterys__5519__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5520__auto__,clojure$test$check$rose_tree$permutations_$_iter__42782(cljs.core.rest(s__42783__$1)));
} else {
var G__42832 = cljs.core.rest(s__42783__$1);
s__42783__$1 = G__42832;
continue;
}
} else {
return null;
...
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__42801_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__42801_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42808_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__42808_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__42808_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__42814 = f;
var G__42815 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__42814,G__42815) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__42814,G__42815));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__42817 = f;
var G__42818 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__42817,G__42818) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__42817,G__42818));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
