...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38785_SHARP_){
return (markdown_to_hiccup.decode.decode.cljs$core$IFn$_invoke$arity$2 ? markdown_to_hiccup.decode.decode.cljs$core$IFn$_invoke$arity$2(p1__38785_SHARP_,transform_str_fn) : markdown_to_hiccup.decode.decode.call(null,p1__38785_SHARP_,transform_str_fn));
}),cljs.core.seq(iseq));
}));
...
var len__5769__auto___38832 = arguments.length;
var i__5770__auto___38833 = (0);
while(true){
if((i__5770__auto___38833 < len__5769__auto___38832)){
...
/** @this {Function} */
(markdown_to_hiccup.decode.dispatch.cljs$lang$applyTo = (function (seq38805){
var G__38806 = cljs.core.first(seq38805);
var seq38805__$1 = cljs.core.next(seq38805);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38806,seq38805__$1);
}));
...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__38811 = cljs.core.get_global_hierarchy;
return (fexpr__38811.cljs$core$IFn$_invoke$arity$0 ? fexpr__38811.cljs$core$IFn$_invoke$arity$0() : fexpr__38811.call(null));
})());
...
var G__38837 = null;
var G__38837__1 = (function (s){
return markdown_to_hiccup.decode.decode_string.cljs$core$IFn$_invoke$arity$1(s);
});
var G__38837__2 = (function (s,transform){
return markdown_to_hiccup.decode.decode_string.cljs$core$IFn$_invoke$arity$2(s,transform);
});
G__38837 = function(s,transform){
switch(arguments.length){
case 1:
return G__38837__1.call(this,s);
case 2:
return G__38837__2.call(this,s,transform);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__38837.cljs$core$IFn$_invoke$arity$1 = G__38837__1;
G__38837.cljs$core$IFn$_invoke$arity$2 = G__38837__2;
return G__38837;
})()
);
...
var G__38838__2 = (function (m,transform){
...
G__38838 = function(m,transform){
switch(arguments.length){
case 1:
return G__38838__1.call(this,m);
case 2:
return G__38838__2.call(this,m,transform);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__38840 = null;
var G__38840__1 = (function (v){
return cljs.core.vec(markdown_to_hiccup.decode.decode_iseq.cljs$core$IFn$_invoke$arity$1(v));
});
var G__38840__2 = (function (v,transform){
return cljs.core.vec(markdown_to_hiccup.decode.decode_iseq.cljs$core$IFn$_invoke$arity$2(v,transform));
});
G__38840 = function(v,transform){
switch(arguments.length){
case 1:
return G__38840__1.call(this,v);
case 2:
return G__38840__2.call(this,v,transform);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__38840.cljs$core$IFn$_invoke$arity$1 = G__38840__1;
G__38840.cljs$core$IFn$_invoke$arity$2 = G__38840__2;
return G__38840;
})()
);
...
var G__38841 = null;
var G__38841__1 = (function (x){
return cljs.core.identity(x);
});
var G__38841__2 = (function (x,f){
return cljs.core.identity(x);
});
G__38841 = function(x,f){
switch(arguments.length){
case 1:
return G__38841__1.call(this,x);
case 2:
return G__38841__2.call(this,x,f);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
