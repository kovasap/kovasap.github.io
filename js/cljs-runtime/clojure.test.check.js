...
var vec__32381 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32381,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32381,(1),null);
...
var G__32524 = (i__5770__auto___32523 + (1));
i__5770__auto___32523 = G__32524;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__32424){
var map__32425 = p__32424;
var map__32425__$1 = cljs.core.__destructure_map(map__32425);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32425__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32425__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32425__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__32426 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32426,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32426,(1),null);
...
var size = first__32446;
var rest_size_seq = seq__32445__$1;
var vec__32447 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32447,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32447,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq32390){
var G__32391 = cljs.core.first(seq32390);
var seq32390__$1 = cljs.core.next(seq32390);
var G__32392 = cljs.core.first(seq32390__$1);
var seq32390__$2 = cljs.core.next(seq32390__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32391,G__32392,seq32390__$2);
}));
...
var map__32478 = smallest;
var map__32478__$1 = cljs.core.__destructure_map(map__32478);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32478__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__32536 = tail;
var G__32537 = current_smallest;
var G__32538 = (total_nodes_visited + (1));
var G__32539 = depth;
nodes = G__32536;
current_smallest = G__32537;
total_nodes_visited = G__32538;
depth = G__32539;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__32496_32540 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__32496_32540) : reporter_fn.call(null,G__32496_32540));

var temp__5802__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5802__auto__){
var children = temp__5802__auto__;
var G__32542 = children;
var G__32543 = new_smallest;
var G__32544 = (total_nodes_visited + (1));
var G__32545 = (depth + (1));
nodes = G__32542;
current_smallest = G__32543;
total_nodes_visited = G__32544;
depth = G__32545;
continue;
} else {
var G__32546 = tail;
var G__32547 = new_smallest;
var G__32548 = (total_nodes_visited + (1));
var G__32549 = depth;
nodes = G__32546;
current_smallest = G__32547;
total_nodes_visited = G__32548;
depth = G__32549;
continue;
}
}
...
var G__32511_32550 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__32511_32550) : reporter_fn.call(null,G__32511_32550));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__32499_SHARP_){
var G__32512 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__32499_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__32512) : reporter_fn.call(null,G__32512));
}));
var G__32513_32551 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__32513_32551) : reporter_fn.call(null,G__32513_32551));
