...
var vec__44132 = temp__5802__auto__;
...
var len__5769__auto___44278 = arguments.length;
var i__5770__auto___44279 = (0);
while(true){
if((i__5770__auto___44279 < len__5769__auto___44278)){
args__5775__auto__.push((arguments[i__5770__auto___44279]));

var G__44280 = (i__5770__auto___44279 + (1));
i__5770__auto___44279 = G__44280;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__44155){
var map__44156 = p__44155;
var map__44156__$1 = cljs.core.__destructure_map(map__44156);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44156__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44156__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44156__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__44160 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44160,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44160,(1),null);
...
var vec__44175 = size_seq__$1;
var seq__44176 = cljs.core.seq(vec__44175);
var first__44177 = cljs.core.first(seq__44176);
var seq__44176__$1 = cljs.core.next(seq__44176);
var size = first__44177;
var rest_size_seq = seq__44176__$1;
var vec__44178 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44178,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44178,(1),null);
...
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44185_44290) : reporter_fn.call(null,G__44185_44290));

var G__44291 = so_far__$1;
var G__44292 = rest_size_seq;
var G__44293 = r2;
so_far = G__44291;
size_seq__$1 = G__44292;
rstate = G__44293;
continue;
} else {
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq44143){
var G__44144 = cljs.core.first(seq44143);
var seq44143__$1 = cljs.core.next(seq44143);
var G__44145 = cljs.core.first(seq44143__$1);
var seq44143__$2 = cljs.core.next(seq44143__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44144,G__44145,seq44143__$2);
}));
...
var map__44199 = smallest;
var map__44199__$1 = cljs.core.__destructure_map(map__44199);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44199__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__44311 = tail;
var G__44312 = current_smallest;
var G__44313 = (total_nodes_visited + (1));
var G__44314 = depth;
nodes = G__44311;
current_smallest = G__44312;
total_nodes_visited = G__44313;
depth = G__44314;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__44240_44315 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44240_44315) : reporter_fn.call(null,G__44240_44315));

var temp__5802__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5802__auto__){
var children = temp__5802__auto__;
var G__44318 = children;
var G__44319 = new_smallest;
var G__44320 = (total_nodes_visited + (1));
var G__44321 = (depth + (1));
nodes = G__44318;
current_smallest = G__44319;
total_nodes_visited = G__44320;
depth = G__44321;
continue;
} else {
var G__44322 = tail;
var G__44323 = new_smallest;
var G__44324 = (total_nodes_visited + (1));
var G__44325 = depth;
nodes = G__44322;
current_smallest = G__44323;
total_nodes_visited = G__44324;
depth = G__44325;
continue;
}
}
...
var G__44258_44332 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44258_44332) : reporter_fn.call(null,G__44258_44332));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__44249_SHARP_){
var G__44262 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__44249_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44262) : reporter_fn.call(null,G__44262));
}));
var G__44263_44334 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44263_44334) : reporter_fn.call(null,G__44263_44334));
