...
cljs.spec.alpha.def_impl(new cljs.core.Keyword("markdown-to-hiccup.core","options","markdown-to-hiccup.core/options",439665020),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","keys","cljs.spec.alpha/keys",1109346032,null),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("markdown-to-hiccup.core","encode?","markdown-to-hiccup.core/encode?",-1516433262)], null)),cljs.spec.alpha.map_spec_impl(cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("markdown-to-hiccup.core","encode?","markdown-to-hiccup.core/encode?",-1516433262)], null),null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__49310){
return cljs.core.map_QMARK_(G__49310);
})], null),(function (G__49310){
return cljs.core.map_QMARK_(G__49310);
...
var len__4864__auto___49379 = arguments.length;
var i__4865__auto___49380 = (0);
while(true){
if((i__4865__auto___49380 < len__4864__auto___49379)){
args__4870__auto__.push((arguments[i__4865__auto___49380]));

var G__49381 = (i__4865__auto___49380 + (1));
i__4865__auto___49380 = G__49381;
continue;
} else {
}
break;
...
var G__49382 = cljs.core.rest(hiccup);
var G__49383 = kws;
hiccup = G__49382;
kws = G__49383;
continue;
...
var G__49384 = cljs.core.rest(hiccup);
var G__49385 = kws;
hiccup = G__49384;
kws = G__49385;
continue;
...
var G__49386 = hiccup;
var G__49387 = cljs.core.rest(kws);
hiccup = G__49386;
kws = G__49387;
continue;
} else {
var G__49388 = cljs.core.rest(hiccup);
var G__49389 = kws;
hiccup = G__49388;
kws = G__49389;
continue;
...
/** @this {Function} */
(markdown_to_hiccup.core.hicc_in.cljs$lang$applyTo = (function (seq49367){
var G__49368 = cljs.core.first(seq49367);
var seq49367__$1 = cljs.core.next(seq49367);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49368,seq49367__$1);
}));

markdown_to_hiccup.core.keywords_QMARK_ = (function markdown_to_hiccup$core$keywords_QMARK_(var_args){
var args__4870__auto__ = [];
var len__4864__auto___49390 = arguments.length;
var i__4865__auto___49391 = (0);
while(true){
if((i__4865__auto___49391 < len__4864__auto___49390)){
args__4870__auto__.push((arguments[i__4865__auto___49391]));

var G__49392 = (i__4865__auto___49391 + (1));
i__4865__auto___49391 = G__49392;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown_to_hiccup.core.keywords_QMARK_.cljs$lang$applyTo = (function (seq49369){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49369));
}));
...
var vec__49370 = cljs.core.first(kw_pairs);
var kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49370,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49370,(1),null);
...
var G__49393 = cljs.core.rest(arglist);
var G__49394 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret_vec,(0),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([curr_arg], 0));
arglist = G__49393;
ret_vec = G__49394;
continue;
} else {
var G__49395 = cljs.core.rest(arglist);
var G__49396 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ret_vec,curr_arg);
arglist = G__49395;
ret_vec = G__49396;
continue;
...
while(true){
var vec__49373 = cljs.core.first(kw_pairs);
var kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49373,(0),null);
var nth_kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49373,(1),null);
...
var G__49397 = remaining;
var G__49398 = kw_pairs;
hiccup = G__49397;
kw_pairs = G__49398;
continue;
} else {
...
var G__49399 = remaining;
var G__49400 = markdown_to_hiccup.core.dec_front(kw_pairs);
hiccup = G__49399;
kw_pairs = G__49400;
continue;
} else {
var G__49401 = remaining;
var G__49402 = kw_pairs;
hiccup = G__49401;
kw_pairs = G__49402;
continue;
}
...
var G__49403 = remaining;
var G__49404 = new_pairs;
hiccup = G__49403;
kw_pairs = G__49404;
continue;
...
var G__49405 = remaining;
var G__49406 = kw_pairs;
hiccup = G__49405;
kw_pairs = G__49406;
continue;
...
/** @this {Function} */
(markdown_to_hiccup.core.hiccup_in.cljs$lang$applyTo = (function (seq49376){
var G__49377 = cljs.core.first(seq49376);
var seq49376__$1 = cljs.core.next(seq49376);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49377,seq49376__$1);
}));
