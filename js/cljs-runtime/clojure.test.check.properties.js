...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k29183,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29183,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__29191){
var vec__29192 = p__29191;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29192,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29192,(1),null);
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29182){
var self__ = this;
var G__29182__$1 = this;
return (new cljs.core.RecordIter((0),G__29182__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29184,other29185){
var self__ = this;
var this29184__$1 = this;
return (((!((other29185 == null)))) && ((((this29184__$1.constructor === other29185.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29184__$1.error,other29185.error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29184__$1.__extmap,other29185.__extmap)))))));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k29183){
var self__ = this;
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__29182){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__29207 = cljs.core.keyword_identical_QMARK_;
var expr__29208 = k__4511__auto__;
if(cljs.core.truth_((pred__29207.cljs$core$IFn$_invoke$arity$2 ? pred__29207.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"error","error",-978969032),expr__29208) : pred__29207.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29208)))){
return (new clojure.test.check.properties.ErrorResult(G__29182,self__.__meta,self__.__extmap,null));
} else {
return (new clojure.test.check.properties.ErrorResult(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__29182),null));
}
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__29182){
var self__ = this;
var this__4501__auto____$1 = this;
return (new clojure.test.check.properties.ErrorResult(self__.error,G__29182,self__.__extmap,self__.__hash));
}));
 ...
 */
clojure.test.check.properties.map__GT_ErrorResult = (function clojure$test$check$properties$map__GT_ErrorResult(G__29186){
var extmap__4542__auto__ = (function (){var G__29226 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__29186,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_(G__29186)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29226);
} else {
return G__29226;
}
})();
return (new clojure.test.check.properties.ErrorResult(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__29186),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
