...
var sablono$interpreter$IInterpreter$interpret$dyn_26882 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_26882(this$);
}
});
...
var x26871_26889 = ctor.prototype;
(x26871_26889.onChange = (function (event){
var this$ = this;
...
(x26871_26889.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__26873) {
case "input":
var G__26874 = (function (){var and__4210__auto__ = cljs.core.object_QMARK_(props);
if(and__4210__auto__){
return props.type;
} else {
return and__4210__auto__;
...
var G__26901 = (i__4819__auto___26900 + (1));
i__4819__auto___26900 = G__26901;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq26875){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26876,G__26877,seq26875__$2);
}));
...
var vec__26879 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26879,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26879,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26879,(2),null);
