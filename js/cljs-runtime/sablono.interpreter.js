...
var sablono$interpreter$IInterpreter$interpret$dyn_40046 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_40046(this$);
}
});
...
var x39964_40050 = ctor.prototype;
(x39964_40050.onChange = (function (event){
var this$ = this;
...
(x39964_40050.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__39974) {
case "input":
var G__39975 = (function (){var and__5043__auto__ = cljs.core.object_QMARK_(props);
if(and__5043__auto__){
return props.type;
} else {
return and__5043__auto__;
...
var i__5770__auto___40061 = (0);
while(true){
if((i__5770__auto___40061 < len__5769__auto___40060)){
args__5775__auto__.push((arguments[i__5770__auto___40061]));

var G__40065 = (i__5770__auto___40061 + (1));
i__5770__auto___40061 = G__40065;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq39978){
...
var vec__40000 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40000,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40000,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40000,(2),null);
