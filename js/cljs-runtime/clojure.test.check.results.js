...
var clojure$test$check$results$Result$pass_QMARK_$dyn_43725 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_43725(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_43731 = (function (result){
var x__4550__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_43731(result);
}
});
