...
var clojure$test$check$results$Result$pass_QMARK_$dyn_42714 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_42714(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_42715 = (function (result){
var x__5393__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_42715(result);
}
});
