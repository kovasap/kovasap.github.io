...
var clojure$test$check$results$Result$pass_QMARK_$dyn_45593 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_45593(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_45598 = (function (result){
var x__4550__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_45598(result);
}
});
