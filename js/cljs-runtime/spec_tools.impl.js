...
var vec__44773 = cljs.core.rest(expr);
...
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44776,(0),null);
var form = seq__44774__$1;
...
var G__44781 = x;
var G__44781__$1 = (((G__44781 == null))?null:spec_tools.impl.polish(G__44781));
var G__44781__$2 = (((G__44781__$1 == null))?null:cljs.core.name(G__44781__$1));
if((G__44781__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__44781__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__44783 = x;
var G__44783__$1 = (((G__44783 == null))?null:cljs.core.name(G__44783));
if((G__44783__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__44783__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__44784){
var map__44785 = p__44784;
var map__44785__$1 = cljs.core.__destructure_map(map__44785);
var data = map__44785__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44785__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44785__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44785__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44785__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__44787){
var map__44788 = p__44787;
var map__44788__$1 = cljs.core.__destructure_map(map__44788);
var data = map__44788__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44788__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44788__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__44789 = data;
var G__44789__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__44789,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__44789);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__44789__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__44789__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__44794 = form;
var G__44794__$1 = (((G__44794 == null))?null:cljs.core.rest(G__44794));
if((G__44794__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__44794__$1);
}
})();
var G__44795 = m;
var G__44795__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__44795,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__44790_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__44790_SHARP_)));
})):G__44795);
var G__44795__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__44795__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__44791_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__44791_SHARP_)));
})):G__44795__$1);
var G__44795__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__44795__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__44792_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__44792_SHARP_));
})):G__44795__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__44795__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__44796 = (function (){var G__44797 = form;
var G__44797__$1 = (((G__44797 == null))?null:cljs.core.rest(G__44797));
if((G__44797__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__44797__$1);
}
})();
var map__44796__$1 = cljs.core.__destructure_map(map__44796);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44796__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44796__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44796__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44796__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__44807 = (function (){var and__4251__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__44814 = form;
var G__44814__$1 = (((G__44814 == null))?null:cljs.core.seq(G__44814));
var G__44814__$2 = (((G__44814__$1 == null))?null:cljs.core.first(G__44814__$1));
if((G__44814__$2 == null)){
return null;
} else {
var fexpr__44815 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__44815.cljs$core$IFn$_invoke$arity$1 ? fexpr__44815.cljs$core$IFn$_invoke$arity$1(G__44814__$2) : fexpr__44815.call(null,G__44814__$2));
}
})():null));
});
/**
...
var len__4864__auto___44894 = arguments.length;
var i__4865__auto___44895 = (0);
while(true){
if((i__4865__auto___44895 < len__4864__auto___44894)){
args__4870__auto__.push((arguments[i__4865__auto___44895]));

var G__44896 = (i__4865__auto___44895 + (1));
i__4865__auto___44895 = G__44896;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq44816){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq44816));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__44822){
var vec__44823 = p__44822;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44823,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44823,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__44839){
var map__44840 = p__44839;
var map__44840__$1 = cljs.core.__destructure_map(map__44840);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44840__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44840__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44840__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44840__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__44833_SHARP_){
return cljs.core.map_QMARK_(p1__44833_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__44834_SHARP_){
return cljs.core.contains_QMARK_(p1__44834_SHARP_,x);
});
}),req_keys));
