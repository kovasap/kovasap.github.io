...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44638_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__44638_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44640_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__44640_SHARP_)));
}),row));
});
...
var G__44648 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__44649 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__44648,G__44649) : expound.printer.format.call(null,G__44648,G__44649));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44656_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__44656_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44657_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__44657_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__44664(s__44665){
...
var c__4650__auto__ = cljs.core.chunk_first(s__44665__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__44667 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__44666 = (0);
while(true){
if((i__44666 < size__4651__auto__)){
var row_idx = cljs.core._nth(c__4650__auto__,i__44666);
cljs.core.chunk_append(b__44667,(function (){var iter__4652__auto__ = ((function (i__44666,row_idx,c__4650__auto__,size__4651__auto__,b__44667,s__44665__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__44664_$_iter__44668(s__44669){
return (new cljs.core.LazySeq(null,((function (i__44666,row_idx,c__4650__auto__,size__4651__auto__,b__44667,s__44665__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__44669__$1 = s__44669;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__44669__$1);
if(temp__5753__auto____$1){
var s__44669__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__44669__$2)){
var c__4650__auto____$1 = cljs.core.chunk_first(s__44669__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__44671 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__44670 = (0);
while(true){
if((i__44670 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__44670);
cljs.core.chunk_append(b__44671,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__44900 = (i__44670 + (1));
i__44670 = G__44900;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44671),expound$printer$multirow_$_iter__44664_$_iter__44668(cljs.core.chunk_rest(s__44669__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44671),null);
}
} else {
var col_idx = cljs.core.first(s__44669__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__44664_$_iter__44668(cljs.core.rest(s__44669__$2)));
}
} else {
return null;
}
...
});})(i__44666,row_idx,c__4650__auto__,size__4651__auto__,b__44667,s__44665__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__44666,row_idx,c__4650__auto__,size__4651__auto__,b__44667,s__44665__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44667),expound$printer$multirow_$_iter__44664(cljs.core.chunk_rest(s__44665__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44667),null);
}
} else {
var row_idx = cljs.core.first(s__44665__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__44665__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__44664_$_iter__44677(s__44678){
return (new cljs.core.LazySeq(null,(function (){
var s__44678__$1 = s__44678;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__44678__$1);
if(temp__5753__auto____$1){
var s__44678__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__44678__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__44678__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__44680 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__44679 = (0);
while(true){
if((i__44679 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__44679);
cljs.core.chunk_append(b__44680,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__44904 = (i__44679 + (1));
i__44679 = G__44904;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44680),expound$printer$multirow_$_iter__44664_$_iter__44677(cljs.core.chunk_rest(s__44678__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44680),null);
}
} else {
var col_idx = cljs.core.first(s__44678__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__44664_$_iter__44677(cljs.core.rest(s__44678__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__44665__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__44664(cljs.core.rest(s__44665__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44682_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__44682_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__44693 = via;
var G__44693__$1 = (((G__44693 == null))?null:cljs.core.last(G__44693));
if((G__44693__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__44693__$1);
}
})();
...
var seq__44697_44920 = cljs.core.seq(problems);
var chunk__44698_44921 = null;
var count__44699_44922 = (0);
var i__44700_44923 = (0);
while(true){
if((i__44700_44923 < count__44699_44922)){
var p_44925 = chunk__44698_44921.cljs$core$IIndexed$_nth$arity$2(null,i__44700_44923);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_44925) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__44926 = seq__44697_44920;
var G__44927 = chunk__44698_44921;
var G__44928 = count__44699_44922;
var G__44929 = (i__44700_44923 + (1));
seq__44697_44920 = G__44926;
chunk__44698_44921 = G__44927;
count__44699_44922 = G__44928;
i__44700_44923 = G__44929;
continue;
} else {
var temp__5753__auto___44930 = cljs.core.seq(seq__44697_44920);
if(temp__5753__auto___44930){
var seq__44697_44931__$1 = temp__5753__auto___44930;
if(cljs.core.chunked_seq_QMARK_(seq__44697_44931__$1)){
var c__4679__auto___44932 = cljs.core.chunk_first(seq__44697_44931__$1);
var G__44933 = cljs.core.chunk_rest(seq__44697_44931__$1);
var G__44934 = c__4679__auto___44932;
var G__44935 = cljs.core.count(c__4679__auto___44932);
var G__44936 = (0);
seq__44697_44920 = G__44933;
chunk__44698_44921 = G__44934;
count__44699_44922 = G__44935;
i__44700_44923 = G__44936;
continue;
} else {
var p_44937 = cljs.core.first(seq__44697_44931__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_44937) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__44938 = cljs.core.next(seq__44697_44931__$1);
var G__44939 = null;
var G__44940 = (0);
var G__44941 = (0);
seq__44697_44920 = G__44938;
chunk__44698_44921 = G__44939;
count__44699_44922 = G__44940;
i__44700_44923 = G__44941;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44696_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__44696_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__44705){
var vec__44706 = p__44705;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44706,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44706,(1),null);
var G__44709 = branch;
...
var vec__44710 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44710,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44710,(1),null);
var G__44715 = branch;
var G__44715__$1 = (((G__44715 instanceof cljs.core.Keyword))?G__44715.fqn:null);
switch (G__44715__$1) {
case "simple":
return new cljs.core.Keyword(null,"kw","kw",1158308175).cljs$core$IFn$_invoke$arity$1(match);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44715__$1)].join('')));
...
var len__4864__auto___44951 = arguments.length;
var i__4865__auto___44952 = (0);
while(true){
if((i__4865__auto___44952 < len__4864__auto___44951)){
args__4870__auto__.push((arguments[i__4865__auto___44952]));

var G__44954 = (i__4865__auto___44952 + (1));
i__4865__auto___44952 = G__44954;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq44716){
var G__44717 = cljs.core.first(seq44716);
var seq44716__$1 = cljs.core.next(seq44716);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44717,seq44716__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44735_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__44735_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__44736_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__44736_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__44737){
var vec__44738 = p__44737;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44738,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44738,(1),null);
...
var _STAR_print_newline_STAR__orig_val__44746_44958 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__44747_44959 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__44748_44960 = true;
var _STAR_print_fn_STAR__temp_val__44749_44961 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__44748_44960);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__44749_44961);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__44747_44959);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__44746_44958);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44751_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__44751_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__44794 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__44796;
var lines = seq__44795__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44783_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__44783_SHARP_)].join('');
}),lines)));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__44819 = show_valid_values_QMARK_;
var G__44820 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__44821 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__44819,G__44820,G__44821) : expound.printer.summary_form.call(null,G__44819,G__44820,G__44821));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__44993 = show_valid_values_QMARK_;
var G__44994 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__44995 = rst__$1;
show_valid_values_QMARK_ = G__44993;
form = G__44994;
in$ = G__44995;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__44824 = show_valid_values_QMARK_;
var G__44825 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__44826 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__44824,G__44825,G__44826) : expound.printer.summary_form.call(null,G__44824,G__44825,G__44826));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__44828 = show_valid_values_QMARK_;
var G__44829 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__44830 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__44828,G__44829,G__44830) : expound.printer.summary_form.call(null,G__44828,G__44829,G__44830));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__44832 = show_valid_values_QMARK_;
var G__44833 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__44834 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__44832,G__44833,G__44834) : expound.printer.summary_form.call(null,G__44832,G__44833,G__44834));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__44838 = show_valid_values_QMARK_;
var G__44839 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__44840 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__44838,G__44839,G__44840) : expound.printer.summary_form.call(null,G__44838,G__44839,G__44840));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44842_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__44842_SHARP_)).length);
...
var map__44850 = problem;
var map__44850__$1 = cljs.core.__destructure_map(map__44850);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44850__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44850__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__44851 = opts;
var map__44851__$1 = cljs.core.__destructure_map(map__44851);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44851__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__44856 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__44857 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__44857);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__44856);
}})();
var vec__44852 = cljs.core.re_find(regex,s);
