...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_31522 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_31522(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_31523 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_31523(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_31524 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_31524(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_31525 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_31525(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_31526 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_31526(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_31527 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_31527(reader);
}
});
...
var G__31577 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__31578 = s.append(c);
c = G__31577;
s = G__31578;
continue;
}
