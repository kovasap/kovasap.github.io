...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function markdown$lists$close_lists_$_iter__41904(s__41905){
return (new cljs.core.LazySeq(null,(function (){
var s__41905__$1 = s__41905;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__41905__$1);
if(temp__5753__auto__){
var s__41905__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41905__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__41905__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__41907 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__41906 = (0);
while(true){
if((i__41906 < size__4651__auto__)){
var vec__41912 = cljs.core._nth(c__4650__auto__,i__41906);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41912,(0),null);
cljs.core.chunk_append(b__41907,["</li></",cljs.core.name(list_type),">"].join(''));

var G__41994 = (i__41906 + (1));
i__41906 = G__41994;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41907),markdown$lists$close_lists_$_iter__41904(cljs.core.chunk_rest(s__41905__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41907),null);
}
} else {
var vec__41915 = cljs.core.first(s__41905__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41915,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__41904(cljs.core.rest(s__41905__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__41926_SHARP_){
return (cljs.core.second(p1__41926_SHARP_) > num_indents);
...
var vec__41947 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41947,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41947,(1),null);
...
var vec__41968 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41968,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41968,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__41973){
var map__41974 = p__41973;
var map__41974__$1 = cljs.core.__destructure_map(map__41974);
var state = map__41974__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41974__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41974__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41974__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41974__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
