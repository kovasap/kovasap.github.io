...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function markdown$lists$close_lists_$_iter__39372(s__39373){
return (new cljs.core.LazySeq(null,(function (){
var s__39373__$1 = s__39373;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__39373__$1);
if(temp__5804__auto__){
var s__39373__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39373__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__39373__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__39375 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__39374 = (0);
while(true){
if((i__39374 < size__5522__auto__)){
var vec__39408 = cljs.core._nth(c__5521__auto__,i__39374);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39408,(0),null);
cljs.core.chunk_append(b__39375,["</li></",cljs.core.name(list_type),">"].join(''));

var G__39584 = (i__39374 + (1));
i__39374 = G__39584;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39375),markdown$lists$close_lists_$_iter__39372(cljs.core.chunk_rest(s__39373__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39375),null);
}
} else {
var vec__39414 = cljs.core.first(s__39373__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39414,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__39372(cljs.core.rest(s__39373__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__39433_SHARP_){
return (cljs.core.second(p1__39433_SHARP_) > num_indents);
...
var vec__39508 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39508,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39508,(1),null);
...
var vec__39553 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39553,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39553,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__39571){
var map__39572 = p__39571;
var map__39572__$1 = cljs.core.__destructure_map(map__39572);
var state = map__39572__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39572__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39572__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39572__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39572__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
