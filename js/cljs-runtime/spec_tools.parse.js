...
var fexpr__40905 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__40905.cljs$core$IFn$_invoke$arity$1 ? fexpr__40905.cljs$core$IFn$_invoke$arity$1(type) : fexpr__40905.call(null,type));
});
...
var G__40913 = spec_tools.impl.normalize_symbol(x);
var G__40914 = null;
var G__40915 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__40913,G__40914,G__40915) : spec_tools.parse.parse_form.call(null,G__40913,G__40914,G__40915));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__40916 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__40917 = x;
var G__40918 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__40916,G__40917,G__40918) : spec_tools.parse.parse_form.call(null,G__40916,G__40917,G__40918));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__41104 = cljs.spec.alpha.form(x);
var G__41105 = options;
x = G__41104;
options = G__41105;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__40919 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__40920 = null;
var G__40921 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__40919,G__40920,G__40921) : spec_tools.parse.parse_form.call(null,G__40919,G__40920,G__40921));
} else {
...
var G__40923 = parse_data;
var G__40923__$1 = (((G__40923 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__40923));
var G__40923__$2 = (((G__40923__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__40923__$1));
var G__40923__$3 = (((G__40923__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__40923__$2));
var G__40923__$4 = (((G__40923__$3 == null))?null:cljs.core.seq(G__40923__$3));
if((G__40923__$4 == null)){
return null;
} else {
return cljs.core.set(G__40923__$4);
}
}
});
...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__40924 = cljs.core.get_global_hierarchy;
return (fexpr__40924.cljs$core$IFn$_invoke$arity$0 ? fexpr__40924.cljs$core$IFn$_invoke$arity$0() : fexpr__40924.call(null));
})());
...
var map__41003 = spec_tools.impl.parse_keys(form);
var map__41003__$1 = cljs.core.__destructure_map(map__41003);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41003__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41003__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41003__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41003__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41003__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__41010 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__41010__$1 = (cljs.core.truth_((function (){var or__4253__auto__ = req;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41010,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__41010);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41010__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__41010__$1;
}
}));
...
var vec__41017 = multi_spec_form;
...
var multi_method_symbol = first__41019__$1;
var ___$1 = seq__41018__$2;
var form = vec__41017;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41031){
var vec__41032 = p__41031;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41032,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41032,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__41043_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__41043_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__41048_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__41048_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__41051_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__41051_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41052_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__41052_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__41053 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__41053__$1 = cljs.core.__destructure_map(map__41053);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41053__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__41059 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__41059__$1 = cljs.core.__destructure_map(map__41059);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41059__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__41080,options){
var vec__41085 = p__41080;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41085,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41085,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41085,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__41089,options){
var vec__41093 = p__41089;
...
var ___$1 = first__41095;
var values = seq__41094__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__41088_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__41088_SHARP_,options);
}),values);
...
var type_priority = (function (p1__41097_SHARP_){
var G__41100 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__41099 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__41097_SHARP_);
return (fexpr__41099.cljs$core$IFn$_invoke$arity$1 ? fexpr__41099.cljs$core$IFn$_invoke$arity$1(G__41100) : fexpr__41099.call(null,G__41100));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41098_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__41098_SHARP_,options);
}),cljs.core.rest(form))));
}));
