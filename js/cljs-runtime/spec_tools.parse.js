...
var fexpr__44893 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__44893.cljs$core$IFn$_invoke$arity$1 ? fexpr__44893.cljs$core$IFn$_invoke$arity$1(type) : fexpr__44893.call(null,type));
});
...
var G__44903 = spec_tools.impl.normalize_symbol(x);
var G__44904 = null;
var G__44905 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__44903,G__44904,G__44905) : spec_tools.parse.parse_form.call(null,G__44903,G__44904,G__44905));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__44906 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__44907 = x;
var G__44908 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__44906,G__44907,G__44908) : spec_tools.parse.parse_form.call(null,G__44906,G__44907,G__44908));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__44986 = cljs.spec.alpha.form(x);
...
var G__44909 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__44910 = null;
var G__44911 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__44909,G__44910,G__44911) : spec_tools.parse.parse_form.call(null,G__44909,G__44910,G__44911));
} else {
...
var G__44916 = parse_data;
var G__44916__$1 = (((G__44916 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__44916));
var G__44916__$2 = (((G__44916__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__44916__$1));
var G__44916__$3 = (((G__44916__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__44916__$2));
var G__44916__$4 = (((G__44916__$3 == null))?null:cljs.core.seq(G__44916__$3));
if((G__44916__$4 == null)){
return null;
} else {
return cljs.core.set(G__44916__$4);
}
}
});
...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__44920 = cljs.core.get_global_hierarchy;
return (fexpr__44920.cljs$core$IFn$_invoke$arity$0 ? fexpr__44920.cljs$core$IFn$_invoke$arity$0() : fexpr__44920.call(null));
})());
...
var map__44942 = spec_tools.impl.parse_keys(form);
...
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44942__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__44943 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__44943__$1 = (cljs.core.truth_((function (){var or__4253__auto__ = req;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44943,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__44943);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44943__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__44943__$1;
}
}));
...
var vec__44952 = multi_spec_form;
...
var _ = first__44954;
var first__44954__$1 = cljs.core.first(seq__44953__$1);
var seq__44953__$2 = cljs.core.next(seq__44953__$1);
var multi_method_symbol = first__44954__$1;
var ___$1 = seq__44953__$2;
var form = vec__44952;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__44955){
var vec__44956 = p__44955;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44956,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44956,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__44959_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__44959_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__44960_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__44960_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__44961_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__44961_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44962_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__44962_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__44963 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__44963__$1 = cljs.core.__destructure_map(map__44963);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44963__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__44965 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__44965__$1 = cljs.core.__destructure_map(map__44965);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44965__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__44967,options){
var vec__44968 = p__44967;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44968,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44968,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44968,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__44972,options){
...
var ___$1 = first__44975;
var values = seq__44974__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__44971_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__44971_SHARP_,options);
}),values);
...
var type_priority = (function (p1__44980_SHARP_){
var G__44983 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__44982 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__44980_SHARP_);
return (fexpr__44982.cljs$core$IFn$_invoke$arity$1 ? fexpr__44982.cljs$core$IFn$_invoke$arity$1(G__44983) : fexpr__44982.call(null,G__44983));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44981_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__44981_SHARP_,options);
}),cljs.core.rest(form))));
}));
