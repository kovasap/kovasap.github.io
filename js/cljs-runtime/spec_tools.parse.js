...
var fexpr__46122 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__46122.cljs$core$IFn$_invoke$arity$1 ? fexpr__46122.cljs$core$IFn$_invoke$arity$1(type) : fexpr__46122.call(null,type));
});
...
var G__46140 = spec_tools.impl.normalize_symbol(x);
var G__46141 = null;
var G__46142 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__46140,G__46141,G__46142) : spec_tools.parse.parse_form.call(null,G__46140,G__46141,G__46142));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__46143 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__46144 = x;
var G__46145 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__46143,G__46144,G__46145) : spec_tools.parse.parse_form.call(null,G__46143,G__46144,G__46145));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__46263 = cljs.spec.alpha.form(x);
var G__46264 = options;
x = G__46263;
options = G__46264;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__46146 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__46147 = null;
var G__46148 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__46146,G__46147,G__46148) : spec_tools.parse.parse_form.call(null,G__46146,G__46147,G__46148));
} else {
...
var G__46152 = parse_data;
var G__46152__$1 = (((G__46152 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__46152));
var G__46152__$2 = (((G__46152__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__46152__$1));
var G__46152__$3 = (((G__46152__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__46152__$2));
var G__46152__$4 = (((G__46152__$3 == null))?null:cljs.core.seq(G__46152__$3));
if((G__46152__$4 == null)){
return null;
} else {
return cljs.core.set(G__46152__$4);
}
}
});
...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__46161 = cljs.core.get_global_hierarchy;
return (fexpr__46161.cljs$core$IFn$_invoke$arity$0 ? fexpr__46161.cljs$core$IFn$_invoke$arity$0() : fexpr__46161.call(null));
})());
...
var map__46199 = spec_tools.impl.parse_keys(form);
var map__46199__$1 = cljs.core.__destructure_map(map__46199);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46199__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46199__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46199__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46199__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46199__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__46200 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__46200__$1 = (cljs.core.truth_((function (){var or__4253__auto__ = req;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46200,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__46200);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46200__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__46200__$1;
}
}));
...
var vec__46201 = multi_spec_form;
var seq__46202 = cljs.core.seq(vec__46201);
var first__46203 = cljs.core.first(seq__46202);
var seq__46202__$1 = cljs.core.next(seq__46202);
var _ = first__46203;
var first__46203__$1 = cljs.core.first(seq__46202__$1);
var seq__46202__$2 = cljs.core.next(seq__46202__$1);
var multi_method_symbol = first__46203__$1;
var ___$1 = seq__46202__$2;
var form = vec__46201;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__46204){
var vec__46205 = p__46204;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46205,(0),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__46208_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__46208_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46209_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__46209_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__46211_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__46211_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46218_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__46218_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__46222 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__46222__$1 = cljs.core.__destructure_map(map__46222);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46222__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__46225 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__46225__$1 = cljs.core.__destructure_map(map__46225);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46225__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__46226,options){
var vec__46227 = p__46226;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46227,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46227,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46227,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__46241,options){
...
var ___$1 = first__46244;
var values = seq__46243__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46236_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__46236_SHARP_,options);
}),values);
...
var type_priority = (function (p1__46248_SHARP_){
var G__46252 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__46251 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__46248_SHARP_);
return (fexpr__46251.cljs$core$IFn$_invoke$arity$1 ? fexpr__46251.cljs$core$IFn$_invoke$arity$1(G__46252) : fexpr__46251.call(null,G__46252));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46249_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__46249_SHARP_,options);
}),cljs.core.rest(form))));
}));
