...
var len__4818__auto___27857 = arguments.length;
var i__4819__auto___27858 = (0);
while(true){
if((i__4819__auto___27858 < len__4818__auto___27857)){
args__4824__auto__.push((arguments[i__4819__auto___27858]));

var G__27859 = (i__4819__auto___27858 + (1));
i__4819__auto___27858 = G__27859;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27760){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27778_SHARP_){
return (!((cljs.core.meta(p1__27778_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27798__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27801){var _e__26852__auto__ = e27801;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e27807){var _e__26852__auto__ = e27807;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27812 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27813 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27813);

try{var map__27816 = opts;
var map__27816__$1 = cljs.core.__destructure_map(map__27816);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27816__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27812);
}});
...
var temp__5751__auto___27873 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___27873)){
var managed_print_level_27874 = temp__5751__auto___27873;
var _STAR_print_level_STAR__orig_val__27831_27875 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27832_27876 = managed_print_level_27874;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27832_27876);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27821_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27821_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27831_27875);
}} else {
job_fn();
}
