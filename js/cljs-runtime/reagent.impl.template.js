...
var G__47236 = o;
reagent.impl.template.goog$module$goog$object.set(G__47236,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__47247 = o;
reagent.impl.template.goog$module$goog$object.set(G__47247,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__47669__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__47669 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__47670__i < G__47670__a.length) {G__47670__a[G__47670__i] = arguments[G__47670__i + 0]; ++G__47670__i;}
  args = new cljs.core.IndexedSeq(G__47670__a,0,null);
} 
return G__47669__delegate.call(this,args);};
G__47669.cljs$lang$maxFixedArity = 0;
G__47669.cljs$lang$applyTo = (function (arglist__47671){
var args = cljs.core.seq(arglist__47671);
return G__47669__delegate(args);
});
G__47669.cljs$core$IFn$_invoke$arity$variadic = G__47669__delegate;
return G__47669;
})()
;
} else {
...
var G__47262 = props;
var G__47262__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47262,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__47262);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47262__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__47265 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47265,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__47265;
}
})(),id_class);
...
var G__47268 = (cljs.core.count(argv) - first_child);
switch (G__47268) {
case (0):
...
var vec__47282 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47282,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47282,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47282,(2),null);
...
var temp__5757__auto___47673 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___47673 == null)){
} else {
var key_47674 = temp__5757__auto___47673;
(jsprops.key = key_47674);
}
...
var temp__5757__auto___47675 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___47675 == null)){
} else {
var key_47676 = temp__5757__auto___47675;
(jsprops.key = key_47676);
}
...
var temp__5757__auto___47677 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___47677 == null)){
} else {
var key_47678 = temp__5757__auto___47677;
(jsprops.key = key_47678);
}
...
var temp__5757__auto___47688 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___47688 == null)){
} else {
var key_47689 = temp__5757__auto___47688;
(jsprops.key = key_47689);
}
...
var temp__5757__auto___47691 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___47691 == null)){
} else {
var key_47694 = temp__5757__auto___47691;
(jsprops.key = key_47694);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47445_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__47445_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__47505 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47505,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47505,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template47659 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template47659 = (function (opts,id,fn_to_element,parse_fn,meta47660){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template47659.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_47661,meta47660__$1){
var self__ = this;
var _47661__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template47659(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta47660__$1));
}));

(reagent.impl.template.t_reagent$impl$template47659.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_47661){
var self__ = this;
var _47661__$1 = this;
return self__.meta47660;
}));

(reagent.impl.template.t_reagent$impl$template47659.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template47659.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template47659.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template47659.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template47659.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template47659.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta47660","meta47660",1837135307,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template47659.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template47659.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template47659");

(reagent.impl.template.t_reagent$impl$template47659.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template47659");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template47659.
 */
reagent.impl.template.__GT_t_reagent$impl$template47659 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template47659(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta47660){
return (new reagent.impl.template.t_reagent$impl$template47659(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta47660));
});

}

return (new reagent.impl.template.t_reagent$impl$template47659(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
