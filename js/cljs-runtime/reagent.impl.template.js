...
var G__64878 = o;
reagent.impl.template.goog$module$goog$object.set(G__64878,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__65056__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__65056 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__65058__i = 0, G__65058__a = new Array(arguments.length -  0);
while (G__65058__i < G__65058__a.length) {G__65058__a[G__65058__i] = arguments[G__65058__i + 0]; ++G__65058__i;}
  args = new cljs.core.IndexedSeq(G__65058__a,0,null);
} 
return G__65056__delegate.call(this,args);};
G__65056.cljs$lang$maxFixedArity = 0;
G__65056.cljs$lang$applyTo = (function (arglist__65059){
var args = cljs.core.seq(arglist__65059);
return G__65056__delegate(args);
});
G__65056.cljs$core$IFn$_invoke$arity$variadic = G__65056__delegate;
return G__65056;
})()
;
} else {
...
var G__64889 = o;
reagent.impl.template.goog$module$goog$object.set(G__64889,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__65066__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__65069__i < G__65069__a.length) {G__65069__a[G__65069__i] = arguments[G__65069__i + 0]; ++G__65069__i;}
  args = new cljs.core.IndexedSeq(G__65069__a,0,null);
} 
return G__65066__delegate.call(this,args);};
G__65066.cljs$lang$maxFixedArity = 0;
G__65066.cljs$lang$applyTo = (function (arglist__65070){
var args = cljs.core.seq(arglist__65070);
return G__65066__delegate(args);
});
...
var G__64891 = props;
var G__64891__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64891,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__64891);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64891__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__64895 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64895,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__64895;
}
})(),id_class);
...
var G__64899 = (cljs.core.count(argv) - first_child);
switch (G__64899) {
case (0):
...
var vec__64914 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64914,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64914,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64914,(2),null);
...
var temp__5757__auto___65094 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___65094 == null)){
} else {
var key_65096 = temp__5757__auto___65094;
...
var temp__5757__auto___65098 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___65098 == null)){
} else {
var key_65100 = temp__5757__auto___65098;
(jsprops.key = key_65100);
}
...
var temp__5757__auto___65107 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___65107 == null)){
} else {
var key_65108 = temp__5757__auto___65107;
(jsprops.key = key_65108);
}
...
var temp__5757__auto___65122 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___65122 == null)){
} else {
var key_65123 = temp__5757__auto___65122;
(jsprops.key = key_65123);
}
...
var temp__5757__auto___65127 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___65127 == null)){
} else {
var key_65128 = temp__5757__auto___65127;
(jsprops.key = key_65128);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__64965_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__64965_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__64970 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64970,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64970,(1),null);
...
break;
default:
var G__65136 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__65137 = compiler;
v = G__65136;
compiler = G__65137;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template65013 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template65013 = (function (opts,id,fn_to_element,parse_fn,meta65014){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta65014 = meta65014;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template65013.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_65015,meta65014__$1){
var self__ = this;
var _65015__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template65013(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta65014__$1));
}));

(reagent.impl.template.t_reagent$impl$template65013.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_65015){
var self__ = this;
var _65015__$1 = this;
return self__.meta65014;
}));

(reagent.impl.template.t_reagent$impl$template65013.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template65013.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template65013.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template65013.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template65013.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template65013.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta65014","meta65014",876940020,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template65013.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template65013.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template65013");

(reagent.impl.template.t_reagent$impl$template65013.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template65013");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template65013.
 */
reagent.impl.template.__GT_t_reagent$impl$template65013 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template65013(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta65014){
return (new reagent.impl.template.t_reagent$impl$template65013(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta65014));
});

}

return (new reagent.impl.template.t_reagent$impl$template65013(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
