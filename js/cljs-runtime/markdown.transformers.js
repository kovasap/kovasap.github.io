...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__26858){
var map__26859 = p__26858;
var map__26859__$1 = cljs.core.__destructure_map(map__26859);
var state = map__26859__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26859__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26859__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__27076 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__27077 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__27076;
remaining = G__27077;
continue;
} else {
var G__27078 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__27079 = cljs.core.rest(remaining);
buf = G__27078;
remaining = G__27079;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__26873){
var map__26875 = p__26873;
var map__26875__$1 = cljs.core.__destructure_map(map__26875);
var state = map__26875__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26875__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26875__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26875__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26875__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26875__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__26881){
var map__26882 = p__26881;
var map__26882__$1 = cljs.core.__destructure_map(map__26882);
var state = map__26882__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26882__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26882__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__26887){
var map__26888 = p__26887;
var map__26888__$1 = cljs.core.__destructure_map(map__26888);
var state = map__26888__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26888__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26888__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__26883_SHARP_){
var vec__26889 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__26883_SHARP_,(1),(cljs.core.count(p1__26883_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26889,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26889,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26894)].join('');
} else {
return G__26894;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__26892_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__26892_SHARP_,(1),(cljs.core.count(p1__26892_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__26919){
var map__26920 = p__26919;
var map__26920__$1 = cljs.core.__destructure_map(map__26920);
var state = map__26920__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26920__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__26942){
var map__26945 = p__26942;
var map__26945__$1 = cljs.core.__destructure_map(map__26945);
var state = map__26945__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26945__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__26953){
var map__26954 = p__26953;
var map__26954__$1 = cljs.core.__destructure_map(map__26954);
var state = map__26954__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26954__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26954__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__5043__auto__ = paragraph;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__26955 = next_line;
if((G__26955 == null)){
return null;
} else {
return clojure.string.trim(G__26955);
}
})()));
} else {
return and__5043__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__26956){
var map__26957 = p__26956;
var map__26957__$1 = cljs.core.__destructure_map(map__26957);
var state = map__26957__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26957__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26957__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26957__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26957__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__26965){
var map__26966 = p__26965;
var map__26966__$1 = cljs.core.__destructure_map(map__26966);
var state = map__26966__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26966__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26966__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26966__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26966__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26966__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__26967 = next_line;
if((G__26967 == null)){
return null;
} else {
return clojure.string.trim(G__26967);
}
})()));
...
var vec__26973 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26973,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26973,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__27005){
var map__27009 = p__27005;
var map__27009__$1 = cljs.core.__destructure_map(map__27009);
var state = map__27009__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27009__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27009__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27009__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27009__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__5045__auto__ = code;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__27032){
var map__27034 = p__27032;
var map__27034__$1 = cljs.core.__destructure_map(map__27034);
var state = map__27034__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27034__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27034__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27034__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27034__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__27038_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__27039){
var vec__27040 = p__27039;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27040,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27040,(1),null);
...
var vec__27043 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27043,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27043,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27043,(2),null);
var vec__27046 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27046,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27046,(1),null);
...
var vec__27069 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27069,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27069,(1),null);
...
var G__27145 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__27146 = cljs.core.rest(remain);
var G__27147 = key;
acc = G__27145;
remain = G__27146;
prev_key = G__27147;
