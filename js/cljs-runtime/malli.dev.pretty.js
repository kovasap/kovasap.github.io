...
return cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"break","break",126570225),(function (){var iter__5523__auto__ = (function malli$dev$pretty$_errors_$_iter__38354(s__38355){
return (new cljs.core.LazySeq(null,(function (){
var s__38355__$1 = s__38355;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__38355__$1);
if(temp__5804__auto__){
var s__38355__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38355__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__38355__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__38357 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__38356 = (0);
while(true){
if((i__38356 < size__5522__auto__)){
var error = cljs.core._nth(c__5521__auto__,i__38356);
cljs.core.chunk_append(b__38357,malli.dev.virhe._visit(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,error),printer));

var G__38392 = (i__38356 + (1));
i__38356 = G__38392;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38357),malli$dev$pretty$_errors_$_iter__38354(cljs.core.chunk_rest(s__38355__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38357),null);
}
} else {
var error = cljs.core.first(s__38355__$2);
return cljs.core.cons(malli.dev.virhe._visit(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,error),printer),malli$dev$pretty$_errors_$_iter__38354(cljs.core.rest(s__38355__$2)));
}
} else {
return null;
}
...
var map__38365 = explanation;
var map__38365__$1 = cljs.core.__destructure_map(map__38365);
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38365__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38365__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-input","malli.core/invalid-input",2010057279),(function (_,___$1,p__38369,printer){
var map__38370 = p__38369;
var map__38370__$1 = cljs.core.__destructure_map(map__38370);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38370__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38370__$1,new cljs.core.Keyword(null,"input","input",556931961));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38370__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-output","malli.core/invalid-output",-147363519),(function (_,___$1,p__38372,printer){
var map__38373 = p__38372;
var map__38373__$1 = cljs.core.__destructure_map(map__38373);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38373__$1,new cljs.core.Keyword(null,"value","value",305978217));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38373__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38373__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38373__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-arity","malli.core/invalid-arity",577014581),(function (_,___$1,p__38374,printer){
var map__38375 = p__38374;
var map__38375__$1 = cljs.core.__destructure_map(map__38375);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38375__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38375__$1,new cljs.core.Keyword(null,"arity","arity",-1808556135));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38375__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38375__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
var _STAR_print_newline_STAR__orig_val__38378_38394 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38379_38395 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38380_38396 = true;
var _STAR_print_fn_STAR__temp_val__38381_38397 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38380_38396);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38381_38397);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38379_38395);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38378_38394);
}
...
var _STAR_print_newline_STAR__orig_val__38384_38399 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38385_38400 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38386_38401 = true;
var _STAR_print_fn_STAR__temp_val__38387_38402 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38386_38401);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38387_38402);

try{report(type,data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38385_38400);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38384_38399);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5690__auto__);
})();
...
return (function() { 
var G__38403__delegate = function (args){
var temp__5804__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,args);
if(cljs.core.truth_(temp__5804__auto__)){
var res = temp__5804__auto__;
var fexpr__38388_38404 = (actor.cljs$core$IFn$_invoke$arity$1 ? actor.cljs$core$IFn$_invoke$arity$1(printer) : actor.call(null,printer));
(fexpr__38388_38404.cljs$core$IFn$_invoke$arity$2 ? fexpr__38388_38404.cljs$core$IFn$_invoke$arity$2(type,res) : fexpr__38388_38404.call(null,type,res));
...
var G__38403 = function (var_args){
var args = null;
...
while (G__38405__i < G__38405__a.length) {G__38405__a[G__38405__i] = arguments[G__38405__i + 0]; ++G__38405__i;}
  args = new cljs.core.IndexedSeq(G__38405__a,0,null);
} 
return G__38403__delegate.call(this,args);};
G__38403.cljs$lang$maxFixedArity = 0;
G__38403.cljs$lang$applyTo = (function (arglist__38406){
var args = cljs.core.seq(arglist__38406);
return G__38403__delegate(args);
});
