...
return cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"break","break",126570225),(function (){var iter__5523__auto__ = (function malli$dev$pretty$_errors_$_iter__50360(s__50361){
return (new cljs.core.LazySeq(null,(function (){
var s__50361__$1 = s__50361;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__50361__$1);
if(temp__5804__auto__){
var s__50361__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50361__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__50361__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__50363 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__50362 = (0);
while(true){
if((i__50362 < size__5522__auto__)){
var error = cljs.core._nth(c__5521__auto__,i__50362);
cljs.core.chunk_append(b__50363,malli.dev.virhe._visit(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,error),printer));

var G__50399 = (i__50362 + (1));
i__50362 = G__50399;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50363),malli$dev$pretty$_errors_$_iter__50360(cljs.core.chunk_rest(s__50361__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50363),null);
}
} else {
var error = cljs.core.first(s__50361__$2);
return cljs.core.cons(malli.dev.virhe._visit(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,error),printer),malli$dev$pretty$_errors_$_iter__50360(cljs.core.rest(s__50361__$2)));
}
} else {
return null;
}
...
var map__50365 = explanation;
var map__50365__$1 = cljs.core.__destructure_map(map__50365);
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50365__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50365__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-input","malli.core/invalid-input",2010057279),(function (_,___$1,p__50366,printer){
var map__50367 = p__50366;
var map__50367__$1 = cljs.core.__destructure_map(map__50367);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50367__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50367__$1,new cljs.core.Keyword(null,"input","input",556931961));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50367__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-output","malli.core/invalid-output",-147363519),(function (_,___$1,p__50368,printer){
var map__50370 = p__50368;
var map__50370__$1 = cljs.core.__destructure_map(map__50370);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50370__$1,new cljs.core.Keyword(null,"value","value",305978217));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50370__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50370__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50370__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-arity","malli.core/invalid-arity",577014581),(function (_,___$1,p__50372,printer){
var map__50373 = p__50372;
var map__50373__$1 = cljs.core.__destructure_map(map__50373);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50373__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50373__$1,new cljs.core.Keyword(null,"arity","arity",-1808556135));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50373__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50373__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
var _STAR_print_newline_STAR__orig_val__50376_50401 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50377_50402 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50378_50403 = true;
var _STAR_print_fn_STAR__temp_val__50379_50404 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50378_50403);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50379_50404);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50377_50402);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50376_50401);
}
...
var _STAR_print_newline_STAR__orig_val__50389_50406 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50390_50407 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50391_50408 = true;
var _STAR_print_fn_STAR__temp_val__50392_50409 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50391_50408);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50392_50409);

try{report(type,data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50390_50407);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50389_50406);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5690__auto__);
})();
...
return (function() { 
var G__50410__delegate = function (args){
var temp__5804__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,args);
if(cljs.core.truth_(temp__5804__auto__)){
var res = temp__5804__auto__;
var fexpr__50394_50411 = (actor.cljs$core$IFn$_invoke$arity$1 ? actor.cljs$core$IFn$_invoke$arity$1(printer) : actor.call(null,printer));
(fexpr__50394_50411.cljs$core$IFn$_invoke$arity$2 ? fexpr__50394_50411.cljs$core$IFn$_invoke$arity$2(type,res) : fexpr__50394_50411.call(null,type,res));
...
while (G__50413__i < G__50413__a.length) {G__50413__a[G__50413__i] = arguments[G__50413__i + 0]; ++G__50413__i;}
  args = new cljs.core.IndexedSeq(G__50413__a,0,null);
} 
...
var args = cljs.core.seq(arglist__50415);
