...
var G__28827 = devtools.prefs.pref(v);
v = G__28827;
continue;
} else {
return v;
...
}catch (e28755){var _e__28008__auto__ = e28755;
return false;
}})();
...
}catch (e28761){var _e__28008__auto__ = e28761;
return false;
}})();
...
}catch (e28763){var _e__28008__auto__ = e28763;
return false;
}}
}
});
...
var vec__28773 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28773,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28773,(1),null);
...
return cljs.core.some((function (p1__28781_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28781_SHARP_);
}),template);
});
