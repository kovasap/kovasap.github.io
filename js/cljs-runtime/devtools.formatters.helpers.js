...
var G__27721 = devtools.prefs.pref(v);
v = G__27721;
continue;
} else {
return v;
...
}catch (e27647){var _e__26852__auto__ = e27647;
return false;
}})();
...
}catch (e27649){var _e__26852__auto__ = e27649;
return false;
}})();
...
}catch (e27655){var _e__26852__auto__ = e27655;
return false;
}}
}
});
...
var vec__27684 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27684,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27684,(1),null);
...
return cljs.core.some((function (p1__27696_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27696_SHARP_);
}),template);
});
