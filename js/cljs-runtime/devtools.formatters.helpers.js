...
var G__55682 = devtools.prefs.pref(v);
v = G__55682;
continue;
} else {
return v;
...
}catch (e55623){var _e__42126__auto__ = e55623;
return false;
}})();
...
}catch (e55629){var _e__42126__auto__ = e55629;
return false;
}})();
...
}catch (e55635){var _e__42126__auto__ = e55635;
return false;
}}
}
});
...
var vec__55656 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(1),null);
...
return cljs.core.some((function (p1__55659_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__55659_SHARP_);
}),template);
});
