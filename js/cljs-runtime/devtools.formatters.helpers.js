...
var G__28755 = devtools.prefs.pref(v);
v = G__28755;
continue;
} else {
return v;
...
}catch (e28713){var _e__28111__auto__ = e28713;
return false;
}})();
...
}catch (e28717){var _e__28111__auto__ = e28717;
return false;
}})();
...
}catch (e28720){var _e__28111__auto__ = e28720;
return false;
}}
}
});
...
var vec__28732 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28732,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28732,(1),null);
...
return cljs.core.some((function (p1__28736_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28736_SHARP_);
}),template);
});
