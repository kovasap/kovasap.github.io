...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33577 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33577(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33580 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33580(runtime,key,spec);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33586 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33586(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33589 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33589(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33590 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33590(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33574,callback){
var map__33575 = p__33574;
var map__33575__$1 = cljs.core.__destructure_map(map__33575);
var input = map__33575__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33575__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33575__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
