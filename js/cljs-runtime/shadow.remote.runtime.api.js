...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33589 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33589(runtime,msg);
}
});
...
var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33595 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33595(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33596 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33596(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33597 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33597(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33600 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33600(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33587,callback){
var map__33588 = p__33587;
var map__33588__$1 = cljs.core.__destructure_map(map__33588);
var input = map__33588__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33588__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33588__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
