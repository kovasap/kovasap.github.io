...
var len__4864__auto___55512 = arguments.length;
var i__4865__auto___55513 = (0);
while(true){
if((i__4865__auto___55513 < len__4864__auto___55512)){
args__4870__auto__.push((arguments[i__4865__auto___55513]));

var G__55514 = (i__4865__auto___55513 + (1));
i__4865__auto___55513 = G__55514;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq55436){
var G__55437 = cljs.core.first(seq55436);
var seq55436__$1 = cljs.core.next(seq55436);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55437,seq55436__$1);
}));
...
return cljs.core.some((function (p1__55449_SHARP_){
return (p1__55449_SHARP_ === object);
}),history);
});
...
var _STAR_ = (function (p__55459){
var vec__55463 = p__55459;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55463,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55463,(1),null);
if((k === val)){
