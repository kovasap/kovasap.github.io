...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__26820){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__26826_SHARP_){
return (((p1__26826_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__26826_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__26830,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__26830;
}
});
...
var len__4818__auto___26868 = arguments.length;
var i__4819__auto___26869 = (0);
while(true){
if((i__4819__auto___26869 < len__4818__auto___26868)){
args__4824__auto__.push((arguments[i__4819__auto___26869]));

var G__26870 = (i__4819__auto___26869 + (1));
i__4819__auto___26869 = G__26870;
continue;
} else {
}
break;
...
var G__26832 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26832,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__26832;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq26831){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq26831));
}));
...
var vec__26846 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__26855 = cljs.core.ffirst(matches);
var fexpr__26854 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26846,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26846,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__26843_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__26843_SHARP_))){
return p1__26843_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__26844_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__26844_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__26861){
var vec__26862 = p__26861;
var seq__26863 = cljs.core.seq(vec__26862);
var first__26864 = cljs.core.first(seq__26863);
var seq__26863__$1 = cljs.core.next(seq__26863);
var tag = first__26864;
var content = seq__26863__$1;
...
var vec__26865 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26865,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26865,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26865,(2),null);
