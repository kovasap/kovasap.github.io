...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__41945){
var vec__41947 = p__41945;
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__41985_SHARP_){
return (((p1__41985_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__41985_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__41993,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__41993;
}
});
...
var len__4864__auto___42063 = arguments.length;
var i__4865__auto___42064 = (0);
while(true){
if((i__4865__auto___42064 < len__4864__auto___42063)){
args__4870__auto__.push((arguments[i__4865__auto___42064]));

var G__42065 = (i__4865__auto___42064 + (1));
i__4865__auto___42064 = G__42065;
continue;
} else {
}
break;
...
var G__42005 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42005,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__42005;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq41998){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq41998));
}));
...
var vec__42017 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__42026 = cljs.core.ffirst(matches);
var fexpr__42025 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__42025.cljs$core$IFn$_invoke$arity$1 ? fexpr__42025.cljs$core$IFn$_invoke$arity$1(G__42026) : fexpr__42025.call(null,G__42026));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42017,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42017,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__42015_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__42015_SHARP_))){
return p1__42015_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__42016_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__42016_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__42052){
var vec__42053 = p__42052;
var seq__42054 = cljs.core.seq(vec__42053);
var first__42055 = cljs.core.first(seq__42054);
var seq__42054__$1 = cljs.core.next(seq__42054);
var tag = first__42055;
var content = seq__42054__$1;
...
var vec__42060 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42060,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42060,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42060,(2),null);
