...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.Keyword(null,"input","input",556931961).cljs$core$IFn$_invoke$arity$1(m)], null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4652__auto__ = (function app$comparison_matrix_table$get_biomarker_regression_result_keys_$_iter__57994(s__57995){
return (new cljs.core.LazySeq(null,(function (){
var s__57995__$1 = s__57995;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__57995__$1);
if(temp__5753__auto__){
var s__57995__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57995__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__57995__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__57997 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__57996 = (0);
while(true){
if((i__57996 < size__4651__auto__)){
var vec__58002 = cljs.core._nth(c__4650__auto__,i__57996);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58002,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58002,(1),null);
cljs.core.chunk_append(b__57997,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.join.cljs$core$IFn$_invoke$arity$2("--",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.name(new cljs.core.Keyword(null,"biomarker","biomarker",-1934144816).cljs$core$IFn$_invoke$arity$1(m)),cljs.core.name(k)], null))),v], null));

var G__58046 = (i__57996 + (1));
i__57996 = G__58046;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57997),app$comparison_matrix_table$get_biomarker_regression_result_keys_$_iter__57994(cljs.core.chunk_rest(s__57995__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57997),null);
}
} else {
var vec__58005 = cljs.core.first(s__57995__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58005,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58005,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.join.cljs$core$IFn$_invoke$arity$2("--",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.name(new cljs.core.Keyword(null,"biomarker","biomarker",-1934144816).cljs$core$IFn$_invoke$arity$1(m)),cljs.core.name(k)], null))),v], null),app$comparison_matrix_table$get_biomarker_regression_result_keys_$_iter__57994(cljs.core.rest(s__57995__$2)));
}
} else {
return null;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([flat_map,new cljs.core.Keyword(null,"aggregates","aggregates",-1684250289).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__58022 = new cljs.core.Keyword(null,"input","input",556931961).cljs$core$IFn$_invoke$arity$1(flat_map);
return (fexpr__58022.cljs$core$IFn$_invoke$arity$1 ? fexpr__58022.cljs$core$IFn$_invoke$arity$1(input_significant_correlations) : fexpr__58022.call(null,input_significant_correlations));
})())], 0));
});
...
var per_input_results = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58023_SHARP_){
return app.comparison_matrix_table.add_aggregates(input_significant_correlations,app.comparison_matrix_table.make_per_input_row(p1__58023_SHARP_));
}),cljs.core.vals(rows_by_input));
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58024_SHARP_){
...
var vec__58042 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/\-\-/);
var biomarker = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58042,(0),null);
var stat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58042,(1),null);
