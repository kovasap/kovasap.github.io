...
var temp__5802__auto____$1 = (o28448["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28449 = temp__5802__auto____$1;
return (o28449["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28088__auto__ = f;
return (o__28088__auto__["toString"]).call(o__28088__auto__);
} else {
return "";
}
}catch (e28456){var _ = e28456;
return "";
}});
...
try{var o__28088__auto___28703 = t;
(o__28088__auto___28703["cljs$lang$ctorPrWriter"]).call(o__28088__auto___28703,t,writer);
}catch (e28466){var __28704 = e28466;
}
...
var char_code = (function (){var o__28088__auto__ = (new String(char$));
return (o__28088__auto__["charCodeAt"]).call(o__28088__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28088__auto__ = String;
return (o__28088__auto__["fromCharCode"]).call(o__28088__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28488 = num_code;
switch (G__28488) {
case (1):
return (185);
...
var o__28088__auto__ = String;
return (o__28088__auto__["fromCharCode"]).call(o__28088__auto__,superscript_code);
});
/**
...
}catch (e28502){var _e__28111__auto__ = e28502;
return false;
}})())){
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28518){
var vec__28519 = p__28518;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28519,(0),null);
...
var G__28715 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28716 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28715;
remaining_tokens = G__28716;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28516){
var G__28517 = cljs.core.first(seq28516);
var seq28516__$1 = cljs.core.next(seq28516);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28517,seq28516__$1);
}));
...
var vec__28528 = cljs.core.split_with((function (p1__28524_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28524_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28528,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28528,(1),null);
...
var vec__28539 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28539,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28539,(1),null);
...
var vec__28549 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28549,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28549,(1),null);
var vec__28552 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28552,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28552,(1),null);
var vec__28555 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28555,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28555,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28555,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28555,(3),null);
...
var vec__28560 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28560,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28560,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28560,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28560,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28560,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28560,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28563 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28563,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28563,(1),null);
var vec__28566 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28566,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28566,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28573 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28573) : devtools.munging.parse_fn_info_deep.call(null,G__28573));
})()));
}
} else {
return fn_info;
...
var G__28737 = (arity + (1));
var G__28738 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28588){
var vec__28589 = p__28588;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28589,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28589,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28603_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28603_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28605_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28605_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___28747 = arguments.length;
var i__5770__auto___28751 = (0);
while(true){
if((i__5770__auto___28751 < len__5769__auto___28747)){
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28615){
var vec__28616 = p__28615;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(0),null);
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28611,seq28610__$1);
}));
...
var map__28631 = options;
var map__28631__$1 = cljs.core.__destructure_map(map__28631);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28631__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28631__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28631__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28631__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28632 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28632,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28632,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28632,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28632,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28632,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28632,(5),null);
...
var o__28088__auto__ = f;
return (o__28088__auto__["getBasis"]).call(o__28088__auto__);
});
/**
...
}catch (e28642){var _e__28111__auto__ = e28642;
...
var G__28760 = (obj[cljs.core.first(path)]);
var G__28761 = cljs.core.rest(path);
obj = G__28760;
path = G__28761;
continue;
} else {
...
var _STAR_ = (function (accum,p__28665){
var vec__28667 = p__28665;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28667,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28667,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28673){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28675,(2),null);
...
var post_process = (function (p__28691){
var vec__28692 = p__28691;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28692,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28692,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28683_SHARP_){
