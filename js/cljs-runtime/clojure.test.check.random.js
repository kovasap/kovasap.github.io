...
var clojure$test$check$random$IRandom$rand_long$dyn_39319 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_39319(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_39320 = (function (rng){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_39320(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_39322 = (function (rng){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_39322(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_39323 = (function (rng,n){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_39323(rng,n);
}
});
...
var G__39300 = z;
if(((24) > (function (){var G__39301 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__39301) : clojure.test.check.random.longs.bit_count.call(null,G__39301));
})())){
return clojure.test.check.random.longs.bit_xor(G__39300,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__39300;
}
});
...
var G__39327 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__39328 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__39327;
ret = G__39328;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__39310){
var map__39311 = p__39310;
var map__39311__$1 = cljs.core.__destructure_map(map__39311);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39311__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__39312 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39312,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39312,(1),null);
