...
var clojure$test$check$random$IRandom$rand_long$dyn_42797 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_42797(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_42798 = (function (rng){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_42798(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_42799 = (function (rng){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_42799(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_42800 = (function (rng,n){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_42800(rng,n);
}
});
...
var G__42704 = z;
if(((24) > (function (){var G__42705 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__42705) : clojure.test.check.random.longs.bit_count.call(null,G__42705));
})())){
return clojure.test.check.random.longs.bit_xor(G__42704,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__42704;
}
});
...
var G__42810 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__42811 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__42810;
ret = G__42811;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__42756){
var map__42757 = p__42756;
var map__42757__$1 = cljs.core.__destructure_map(map__42757);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42757__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__42764 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42764,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42764,(1),null);
