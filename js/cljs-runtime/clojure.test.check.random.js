...
var clojure$test$check$random$IRandom$rand_long$dyn_42474 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_42474(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_42476 = (function (rng){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_42476(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_42478 = (function (rng){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_42478(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_42480 = (function (rng,n){
var x__4550__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_42480(rng,n);
}
});
...
var G__42443 = z;
if(((24) > (function (){var G__42444 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__42444) : clojure.test.check.random.longs.bit_count.call(null,G__42444));
})())){
return clojure.test.check.random.longs.bit_xor(G__42443,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__42443;
}
});
...
var G__42488 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__42489 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__42488;
ret = G__42489;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__42460){
var map__42461 = p__42460;
var map__42461__$1 = cljs.core.__destructure_map(map__42461);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42461__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__42464 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42464,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42464,(1),null);
