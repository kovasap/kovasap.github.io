...
var _STAR_config_cache_47023 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516),(0),new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378),null], null));
var read_config_file_47024 = (function (){
return null;
});
var reload_config_47025 = (function (){
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.PersistentArrayMap.EMPTY,read_config_file_47024(),cljs_compiler_config], 0));
} else {
return null;
}
})();
if(cljs.core.truth_(plain_config)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__46994){
...
return reload_config_47025();
} else {
var now = cljs.core.identity(Date.now());
if(((now - new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_config_cache_47023))) < (2000))){
return new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_config_cache_47023));
} else {
return new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378).cljs$core$IFn$_invoke$arity$1(cljs.core.reset_BANG_(_STAR_config_cache_47023,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516),now,new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378),reload_config_47025()], null)));
}
}
}));
...
var ns_replacements = (function (){var G__47021 = new cljs.core.PersistentArrayMap(null, 6, ["clojure.core","cljs.core","clojure.test","cljs.test","clojure.spec.alpha","cljs.spec.alpha","clojure.spec.test.alpha","cljs.spec.test.alpha","orchestra.spec.test","orchestra-cljs.spec.test","clojure.spec.gen.alpha","cljs.spec.gen.alpha"], null);
if(cljs.core.truth_(strip_core_ns)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__47021,new cljs.core.PersistentArrayMap(null, 2, ["clojure.core",null,"cljs.core",null], null)], 0));
} else {
return G__47021;
}
})();
var replace_namespace = (function (p1__47009_SHARP_){
if((!(cljs.core.qualified_symbol_QMARK_(p1__47009_SHARP_)))){
return p1__47009_SHARP_;
} else {
var nspace = cljs.core.namespace(p1__47009_SHARP_);
if(cljs.core.contains_QMARK_(ns_replacements,nspace)){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(ns_replacements,nspace),cljs.core.name(p1__47009_SHARP_));
} else {
return p1__47009_SHARP_;
}
}
