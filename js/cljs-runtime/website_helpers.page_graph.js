...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__47255(s__47256){
return (new cljs.core.LazySeq(null,(function (){
var s__47256__$1 = s__47256;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__47256__$1);
if(temp__5825__auto__){
var s__47256__$2 = temp__5825__auto__;
...
var node = cljs.core._nth(c__5521__auto__,i__47257);
cljs.core.chunk_append(b__47258,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__47257,node,c__5521__auto__,size__5522__auto__,b__47258,s__47256__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__47255_$_iter__47260(s__47261){
return (new cljs.core.LazySeq(null,((function (i__47257,node,c__5521__auto__,size__5522__auto__,b__47258,s__47256__$2,temp__5825__auto__){
return (function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47263),website_helpers$page_graph$get_category_links_$_iter__47255_$_iter__47260(cljs.core.chunk_rest(s__47261__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47263),null);
}
} else {
var category = cljs.core.first(s__47261__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__47255_$_iter__47260(cljs.core.rest(s__47261__$2)));
} else {
var G__47330 = cljs.core.rest(s__47261__$2);
s__47261__$1 = G__47330;
continue;
}
}
} else {
...
});})(i__47257,node,c__5521__auto__,size__5522__auto__,b__47258,s__47256__$2,temp__5825__auto__))
,null,null));
});})(i__47257,node,c__5521__auto__,size__5522__auto__,b__47258,s__47256__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47258),website_helpers$page_graph$get_category_links_$_iter__47255(cljs.core.chunk_rest(s__47256__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47258),null);
}
} else {
var node = cljs.core.first(s__47256__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__47256__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__47255_$_iter__47265(s__47266){
return (new cljs.core.LazySeq(null,(function (){
var s__47266__$1 = s__47266;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__47266__$1);
if(temp__5825__auto____$1){
var s__47266__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__47266__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__47266__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__47268 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__47267 = (0);
while(true){
if((i__47267 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__47267);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__47268,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__47332 = (i__47267 + (1));
i__47267 = G__47332;
continue;
} else {
var G__47333 = (i__47267 + (1));
i__47267 = G__47333;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47268),website_helpers$page_graph$get_category_links_$_iter__47255_$_iter__47265(cljs.core.chunk_rest(s__47266__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47268),null);
}
} else {
var category = cljs.core.first(s__47266__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__47255_$_iter__47265(cljs.core.rest(s__47266__$2)));
} else {
var G__47334 = cljs.core.rest(s__47266__$2);
s__47266__$1 = G__47334;
continue;
}
}
} else {
...
});})(node,s__47256__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.Keyword(null,"categories","categories",178386610).cljs$core$IFn$_invoke$arity$1(node));
})()),website_helpers$page_graph$get_category_links_$_iter__47255(cljs.core.rest(s__47256__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__47273(s__47274){
return (new cljs.core.LazySeq(null,(function (){
var s__47274__$1 = s__47274;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__47274__$1);
if(temp__5825__auto__){
var s__47274__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47274__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__47274__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__47276 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__47275 = (0);
while(true){
if((i__47275 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__47275);
cljs.core.chunk_append(b__47276,(function (){var fexpr__47278 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__47278.cljs$core$IFn$_invoke$arity$1 ? fexpr__47278.cljs$core$IFn$_invoke$arity$1(n) : fexpr__47278.call(null,n));
})());

var G__47338 = (i__47275 + (1));
i__47275 = G__47338;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47276),website_helpers$page_graph$iter__47273(cljs.core.chunk_rest(s__47274__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47276),null);
}
} else {
var n = cljs.core.first(s__47274__$2);
return cljs.core.cons((function (){var fexpr__47283 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__47283.cljs$core$IFn$_invoke$arity$1 ? fexpr__47283.cljs$core$IFn$_invoke$arity$1(n) : fexpr__47283.call(null,n));
})(),website_helpers$page_graph$iter__47273(cljs.core.rest(s__47274__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq47271){
var G__47272 = cljs.core.first(seq47271);
var seq47271__$1 = cljs.core.next(seq47271);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47272,seq47271__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__47292_SHARP_){
if((p1__47292_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__47292_SHARP_ / (10)));
}
}));
});
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__47297_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__47297_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__47298_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__47298_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__47299_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__47299_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__47300_SHARP_){
return clojure.string.replace(p1__47300_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__47301_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__47301_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__47302(s__47303){
return (new cljs.core.LazySeq(null,(function (){
...
var c__5521__auto__ = cljs.core.chunk_first(s__47303__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__47305 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__47304 = (0);
while(true){
if((i__47304 < size__5522__auto__)){
var vec__47306 = cljs.core._nth(c__5521__auto__,i__47304);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47306,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47306,(1),null);
cljs.core.chunk_append(b__47305,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__47339 = (i__47304 + (1));
i__47304 = G__47339;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47305),website_helpers$page_graph$index_categories_$_iter__47302(cljs.core.chunk_rest(s__47303__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47305),null);
}
} else {
var vec__47309 = cljs.core.first(s__47303__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47309,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47309,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__47302(cljs.core.rest(s__47303__$2)));
}
} else {
return null;
}
...
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47312_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__47312_SHARP_));
}),notes__$1));
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47313_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__47313_SHARP_));
}),notes__$1));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47321),website_helpers$page_graph$notes_to_graph_$_iter__47318(cljs.core.chunk_rest(s__47319__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47321),null);
}
} else {
var vec__47325 = cljs.core.first(s__47319__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47325,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47325,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__47318(cljs.core.rest(s__47319__$2)));
}
} else {
return null;
}
