...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__21851(s__21852){
return (new cljs.core.LazySeq(null,(function (){
var s__21852__$1 = s__21852;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__21852__$1);
if(temp__5823__auto__){
var s__21852__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21852__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__21852__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__21854 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__21853 = (0);
while(true){
if((i__21853 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__21853);
cljs.core.chunk_append(b__21854,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__21853,node,c__5521__auto__,size__5522__auto__,b__21854,s__21852__$2,temp__5823__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__21851_$_iter__21857(s__21858){
return (new cljs.core.LazySeq(null,((function (i__21853,node,c__5521__auto__,size__5522__auto__,b__21854,s__21852__$2,temp__5823__auto__){
return (function (){
var s__21858__$1 = s__21858;
while(true){
var temp__5823__auto____$1 = cljs.core.seq(s__21858__$1);
if(temp__5823__auto____$1){
var s__21858__$2 = temp__5823__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21858__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__21858__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__21860 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__21859 = (0);
while(true){
if((i__21859 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__21859);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__21860,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__22433 = (i__21859 + (1));
i__21859 = G__22433;
continue;
} else {
var G__22434 = (i__21859 + (1));
i__21859 = G__22434;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21860),website_helpers$page_graph$get_category_links_$_iter__21851_$_iter__21857(cljs.core.chunk_rest(s__21858__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21860),null);
}
} else {
var category = cljs.core.first(s__21858__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__21851_$_iter__21857(cljs.core.rest(s__21858__$2)));
} else {
var G__22453 = cljs.core.rest(s__21858__$2);
s__21858__$1 = G__22453;
continue;
}
}
} else {
...
});})(i__21853,node,c__5521__auto__,size__5522__auto__,b__21854,s__21852__$2,temp__5823__auto__))
,null,null));
});})(i__21853,node,c__5521__auto__,size__5522__auto__,b__21854,s__21852__$2,temp__5823__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21854),website_helpers$page_graph$get_category_links_$_iter__21851(cljs.core.chunk_rest(s__21852__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21854),null);
}
} else {
var node = cljs.core.first(s__21852__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__21852__$2,temp__5823__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__21851_$_iter__21875(s__21876){
return (new cljs.core.LazySeq(null,(function (){
var s__21876__$1 = s__21876;
while(true){
var temp__5823__auto____$1 = cljs.core.seq(s__21876__$1);
if(temp__5823__auto____$1){
var s__21876__$2 = temp__5823__auto____$1;
...
var category = cljs.core._nth(c__5521__auto__,i__21877);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__21878,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__22478 = (i__21877 + (1));
i__21877 = G__22478;
continue;
} else {
var G__22479 = (i__21877 + (1));
i__21877 = G__22479;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21878),website_helpers$page_graph$get_category_links_$_iter__21851_$_iter__21875(cljs.core.chunk_rest(s__21876__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21878),null);
}
} else {
var category = cljs.core.first(s__21876__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__21851_$_iter__21875(cljs.core.rest(s__21876__$2)));
} else {
var G__22503 = cljs.core.rest(s__21876__$2);
s__21876__$1 = G__22503;
continue;
}
}
} else {
...
});})(node,s__21852__$2,temp__5823__auto__))
;
return iter__5523__auto__(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-categories","path-categories",1155646784).cljs$core$IFn$_invoke$arity$1(node)))], null));
})()),website_helpers$page_graph$get_category_links_$_iter__21851(cljs.core.rest(s__21852__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__21895(s__21896){
return (new cljs.core.LazySeq(null,(function (){
...
var c__5521__auto__ = cljs.core.chunk_first(s__21896__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__21898 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__21897 = (0);
while(true){
if((i__21897 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__21897);
cljs.core.chunk_append(b__21898,(function (){var fexpr__21905 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__21905.cljs$core$IFn$_invoke$arity$1 ? fexpr__21905.cljs$core$IFn$_invoke$arity$1(n) : fexpr__21905.call(null,n));
})());

var G__22535 = (i__21897 + (1));
i__21897 = G__22535;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21898),website_helpers$page_graph$iter__21895(cljs.core.chunk_rest(s__21896__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21898),null);
}
} else {
var n = cljs.core.first(s__21896__$2);
return cljs.core.cons((function (){var fexpr__21906 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__21906.cljs$core$IFn$_invoke$arity$1 ? fexpr__21906.cljs$core$IFn$_invoke$arity$1(n) : fexpr__21906.call(null,n));
})(),website_helpers$page_graph$iter__21895(cljs.core.rest(s__21896__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq21885){
var G__21888 = cljs.core.first(seq21885);
var seq21885__$1 = cljs.core.next(seq21885);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21888,seq21885__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__21915_SHARP_){
if((p1__21915_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__21915_SHARP_ / (10)));
}
}));
});
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__21937_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__21937_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__21938_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__21938_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__21939_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__21939_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__21946_SHARP_){
return clojure.string.replace(p1__21946_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__21956_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__21956_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__21962(s__21963){
return (new cljs.core.LazySeq(null,(function (){
var s__21963__$1 = s__21963;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__21963__$1);
if(temp__5823__auto__){
var s__21963__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21963__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__21963__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__21965 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__21964 = (0);
while(true){
if((i__21964 < size__5522__auto__)){
var vec__21974 = cljs.core._nth(c__5521__auto__,i__21964);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21974,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21974,(1),null);
cljs.core.chunk_append(b__21965,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__22646 = (i__21964 + (1));
i__21964 = G__22646;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21965),website_helpers$page_graph$index_categories_$_iter__21962(cljs.core.chunk_rest(s__21963__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21965),null);
}
} else {
var vec__21991 = cljs.core.first(s__21963__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21991,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21991,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__21962(cljs.core.rest(s__21963__$2)));
}
} else {
return null;
}
...
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22017_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__22017_SHARP_));
}),notes__$1));
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22022_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__22022_SHARP_));
}),notes__$1));
...
var c__5521__auto__ = cljs.core.chunk_first(s__22173__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__22175 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__22174 = (0);
while(true){
if((i__22174 < size__5522__auto__)){
var vec__22203 = cljs.core._nth(c__5521__auto__,i__22174);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22203,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22203,(1),null);
cljs.core.chunk_append(b__22175,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__22693 = (i__22174 + (1));
i__22174 = G__22693;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22175),website_helpers$page_graph$notes_to_graph_$_iter__22172(cljs.core.chunk_rest(s__22173__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22175),null);
}
} else {
var vec__22219 = cljs.core.first(s__22173__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22219,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22219,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__22172(cljs.core.rest(s__22173__$2)));
}
} else {
return null;
}
