...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__45042(s__45043){
return (new cljs.core.LazySeq(null,(function (){
var s__45043__$1 = s__45043;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__45043__$1);
if(temp__5825__auto__){
var s__45043__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45043__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__45043__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__45045 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__45044 = (0);
while(true){
if((i__45044 < size__5522__auto__)){
var node = cljs.core._nth(c__5521__auto__,i__45044);
cljs.core.chunk_append(b__45045,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__45044,node,c__5521__auto__,size__5522__auto__,b__45045,s__45043__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__45042_$_iter__45057(s__45058){
return (new cljs.core.LazySeq(null,((function (i__45044,node,c__5521__auto__,size__5522__auto__,b__45045,s__45043__$2,temp__5825__auto__){
return (function (){
var s__45058__$1 = s__45058;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__45058__$1);
if(temp__5825__auto____$1){
var s__45058__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__45058__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__45058__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__45060 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__45059 = (0);
while(true){
if((i__45059 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__45059);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__45060,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__45112 = (i__45059 + (1));
i__45059 = G__45112;
continue;
} else {
var G__45113 = (i__45059 + (1));
i__45059 = G__45113;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45060),website_helpers$page_graph$get_category_links_$_iter__45042_$_iter__45057(cljs.core.chunk_rest(s__45058__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45060),null);
}
} else {
var category = cljs.core.first(s__45058__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__45042_$_iter__45057(cljs.core.rest(s__45058__$2)));
} else {
var G__45114 = cljs.core.rest(s__45058__$2);
s__45058__$1 = G__45114;
continue;
}
}
} else {
...
});})(i__45044,node,c__5521__auto__,size__5522__auto__,b__45045,s__45043__$2,temp__5825__auto__))
,null,null));
});})(i__45044,node,c__5521__auto__,size__5522__auto__,b__45045,s__45043__$2,temp__5825__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45045),website_helpers$page_graph$get_category_links_$_iter__45042(cljs.core.chunk_rest(s__45043__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45045),null);
}
} else {
var node = cljs.core.first(s__45043__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__45043__$2,temp__5825__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__45042_$_iter__45066(s__45067){
return (new cljs.core.LazySeq(null,(function (){
var s__45067__$1 = s__45067;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__45067__$1);
if(temp__5825__auto____$1){
var s__45067__$2 = temp__5825__auto____$1;
...
var category = cljs.core._nth(c__5521__auto__,i__45068);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__45069,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__45116 = (i__45068 + (1));
i__45068 = G__45116;
continue;
} else {
var G__45117 = (i__45068 + (1));
i__45068 = G__45117;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45069),website_helpers$page_graph$get_category_links_$_iter__45042_$_iter__45066(cljs.core.chunk_rest(s__45067__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45069),null);
}
} else {
var category = cljs.core.first(s__45067__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__45042_$_iter__45066(cljs.core.rest(s__45067__$2)));
} else {
var G__45118 = cljs.core.rest(s__45067__$2);
s__45067__$1 = G__45118;
continue;
}
}
} else {
...
});})(node,s__45043__$2,temp__5825__auto__))
;
return iter__5523__auto__(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-categories","path-categories",1155646784).cljs$core$IFn$_invoke$arity$1(node)))], null));
})()),website_helpers$page_graph$get_category_links_$_iter__45042(cljs.core.rest(s__45043__$2)));
}
} else {
return null;
}
...
var G__45121 = (i__5770__auto___45120 + (1));
i__5770__auto___45120 = G__45121;
continue;
} else {
}
break;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__45073(s__45074){
return (new cljs.core.LazySeq(null,(function (){
var s__45074__$1 = s__45074;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__45074__$1);
if(temp__5825__auto__){
var s__45074__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45074__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__45074__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__45076 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__45075 = (0);
while(true){
if((i__45075 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__45075);
cljs.core.chunk_append(b__45076,(function (){var fexpr__45077 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__45077.cljs$core$IFn$_invoke$arity$1 ? fexpr__45077.cljs$core$IFn$_invoke$arity$1(n) : fexpr__45077.call(null,n));
})());

var G__45122 = (i__45075 + (1));
i__45075 = G__45122;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45076),website_helpers$page_graph$iter__45073(cljs.core.chunk_rest(s__45074__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45076),null);
}
} else {
var n = cljs.core.first(s__45074__$2);
return cljs.core.cons((function (){var fexpr__45078 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__45078.cljs$core$IFn$_invoke$arity$1 ? fexpr__45078.cljs$core$IFn$_invoke$arity$1(n) : fexpr__45078.call(null,n));
})(),website_helpers$page_graph$iter__45073(cljs.core.rest(s__45074__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq45071){
var G__45072 = cljs.core.first(seq45071);
var seq45071__$1 = cljs.core.next(seq45071);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45072,seq45071__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__45079_SHARP_){
if((p1__45079_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__45079_SHARP_ / (10)));
}
}));
});
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__45080_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__45080_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__45081_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__45081_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__45082_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__45082_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__45083_SHARP_){
return clojure.string.replace(p1__45083_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__45084_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__45084_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__45085(s__45086){
return (new cljs.core.LazySeq(null,(function (){
var s__45086__$1 = s__45086;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__45086__$1);
if(temp__5825__auto__){
var s__45086__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45086__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__45086__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__45088 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__45087 = (0);
while(true){
if((i__45087 < size__5522__auto__)){
var vec__45089 = cljs.core._nth(c__5521__auto__,i__45087);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45089,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45089,(1),null);
cljs.core.chunk_append(b__45088,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__45123 = (i__45087 + (1));
i__45087 = G__45123;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45088),website_helpers$page_graph$index_categories_$_iter__45085(cljs.core.chunk_rest(s__45086__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45088),null);
}
} else {
var vec__45092 = cljs.core.first(s__45086__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45092,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45092,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__45085(cljs.core.rest(s__45086__$2)));
}
} else {
return null;
}
...
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45095_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__45095_SHARP_));
}),notes__$1));
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45096_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__45096_SHARP_));
}),notes__$1));
var earliest_mod_time = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.zero_QMARK_,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816),notes__$1)))));
...
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Making ",cljs.core.count(notes__$1)," nodes"], 0));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45105),website_helpers$page_graph$notes_to_graph_$_iter__45102(cljs.core.chunk_rest(s__45103__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45105),null);
}
} else {
var vec__45109 = cljs.core.first(s__45103__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45109,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45109,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__45102(cljs.core.rest(s__45103__$2)));
}
} else {
return null;
}
