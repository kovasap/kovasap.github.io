...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$get_category_links_$_iter__21615(s__21616){
return (new cljs.core.LazySeq(null,(function (){
var s__21616__$1 = s__21616;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__21616__$1);
if(temp__5823__auto__){
var s__21616__$2 = temp__5823__auto__;
...
var node = cljs.core._nth(c__5521__auto__,i__21617);
cljs.core.chunk_append(b__21618,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (i__21617,node,c__5521__auto__,size__5522__auto__,b__21618,s__21616__$2,temp__5823__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__21615_$_iter__21622(s__21623){
return (new cljs.core.LazySeq(null,((function (i__21617,node,c__5521__auto__,size__5522__auto__,b__21618,s__21616__$2,temp__5823__auto__){
return (function (){
var s__21623__$1 = s__21623;
while(true){
var temp__5823__auto____$1 = cljs.core.seq(s__21623__$1);
if(temp__5823__auto____$1){
var s__21623__$2 = temp__5823__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21623__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__21623__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__21625 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__21624 = (0);
while(true){
if((i__21624 < size__5522__auto____$1)){
var category = cljs.core._nth(c__5521__auto____$1,i__21624);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__21625,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__22160 = (i__21624 + (1));
i__21624 = G__22160;
continue;
} else {
var G__22161 = (i__21624 + (1));
i__21624 = G__22161;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21625),website_helpers$page_graph$get_category_links_$_iter__21615_$_iter__21622(cljs.core.chunk_rest(s__21623__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21625),null);
}
} else {
var category = cljs.core.first(s__21623__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__21615_$_iter__21622(cljs.core.rest(s__21623__$2)));
} else {
var G__22162 = cljs.core.rest(s__21623__$2);
s__21623__$1 = G__22162;
continue;
}
}
} else {
...
});})(i__21617,node,c__5521__auto__,size__5522__auto__,b__21618,s__21616__$2,temp__5823__auto__))
,null,null));
});})(i__21617,node,c__5521__auto__,size__5522__auto__,b__21618,s__21616__$2,temp__5823__auto__))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21618),website_helpers$page_graph$get_category_links_$_iter__21615(cljs.core.chunk_rest(s__21616__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21618),null);
}
} else {
var node = cljs.core.first(s__21616__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = ((function (node,s__21616__$2,temp__5823__auto__){
return (function website_helpers$page_graph$get_category_links_$_iter__21615_$_iter__21631(s__21632){
return (new cljs.core.LazySeq(null,(function (){
var s__21632__$1 = s__21632;
while(true){
var temp__5823__auto____$1 = cljs.core.seq(s__21632__$1);
if(temp__5823__auto____$1){
var s__21632__$2 = temp__5823__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21632__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__21632__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__21634 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__21633 = (0);
while(true){
if((i__21633 < size__5522__auto__)){
var category = cljs.core._nth(c__5521__auto__,i__21633);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
cljs.core.chunk_append(b__21634,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null));

var G__22193 = (i__21633 + (1));
i__21633 = G__22193;
continue;
} else {
var G__22195 = (i__21633 + (1));
i__21633 = G__22195;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21634),website_helpers$page_graph$get_category_links_$_iter__21615_$_iter__21631(cljs.core.chunk_rest(s__21632__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21634),null);
}
} else {
var category = cljs.core.first(s__21632__$2);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(categories_to_idx,category);
if(cljs.core.truth_(idx)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"target","target",253001721),idx,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$get_category_links_$_iter__21615_$_iter__21631(cljs.core.rest(s__21632__$2)));
} else {
var G__22214 = cljs.core.rest(s__21632__$2);
s__21632__$1 = G__22214;
continue;
}
}
} else {
...
});})(node,s__21616__$2,temp__5823__auto__))
;
return iter__5523__auto__(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-categories","path-categories",1155646784).cljs$core$IFn$_invoke$arity$1(node)))], null));
})()),website_helpers$page_graph$get_category_links_$_iter__21615(cljs.core.rest(s__21616__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$iter__21658(s__21659){
return (new cljs.core.LazySeq(null,(function (){
var s__21659__$1 = s__21659;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__21659__$1);
if(temp__5823__auto__){
var s__21659__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21659__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__21659__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__21661 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__21660 = (0);
while(true){
if((i__21660 < size__5522__auto__)){
var n = cljs.core._nth(c__5521__auto__,i__21660);
cljs.core.chunk_append(b__21661,(function (){var fexpr__21669 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__21669.cljs$core$IFn$_invoke$arity$1 ? fexpr__21669.cljs$core$IFn$_invoke$arity$1(n) : fexpr__21669.call(null,n));
})());

var G__22247 = (i__21660 + (1));
i__21660 = G__22247;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21661),website_helpers$page_graph$iter__21658(cljs.core.chunk_rest(s__21659__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21661),null);
}
} else {
var n = cljs.core.first(s__21659__$2);
return cljs.core.cons((function (){var fexpr__21673 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,update_fns);
return (fexpr__21673.cljs$core$IFn$_invoke$arity$1 ? fexpr__21673.cljs$core$IFn$_invoke$arity$1(n) : fexpr__21673.call(null,n));
})(),website_helpers$page_graph$iter__21658(cljs.core.rest(s__21659__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(website_helpers.page_graph.update_nodes.cljs$lang$applyTo = (function (seq21648){
var G__21654 = cljs.core.first(seq21648);
var seq21648__$1 = cljs.core.next(seq21648);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21654,seq21648__$1);
}));

website_helpers.page_graph.scale_size = (function website_helpers$page_graph$scale_size(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"size","size",1098693007),(function (p1__21678_SHARP_){
if((p1__21678_SHARP_ == null)){
return (20);
} else {
return Math.sqrt((p1__21678_SHARP_ / (10)));
}
}));
});
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__21699_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__21699_SHARP_,/\./));
})),new cljs.core.Keyword(null,"path","path",-188191168),(function (p1__21700_SHARP_){
return clojure.string.replace(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__21700_SHARP_,/\./)),/content\//,"");
})),new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__21701_SHARP_){
return cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__21701_SHARP_,/\./));
}));
}
});
website_helpers.page_graph.fix_path = (function website_helpers$page_graph$fix_path(node){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"tree-path","tree-path",683503647),(function (p1__21714_SHARP_){
return clojure.string.replace(p1__21714_SHARP_,/\/home/,"docs/");
}));
});
/**
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(node,new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__21717_SHARP_){
return website_helpers.page_graph.capitalize_words(clojure.string.replace(p1__21717_SHARP_,/-/," "));
}));
});
website_helpers.page_graph.index_categories = (function website_helpers$page_graph$index_categories(categories,num_notes){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function website_helpers$page_graph$index_categories_$_iter__21718(s__21719){
return (new cljs.core.LazySeq(null,(function (){
var s__21719__$1 = s__21719;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__21719__$1);
if(temp__5823__auto__){
var s__21719__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21719__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__21719__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__21721 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__21720 = (0);
while(true){
if((i__21720 < size__5522__auto__)){
var vec__21722 = cljs.core._nth(c__5521__auto__,i__21720);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21722,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21722,(1),null);
cljs.core.chunk_append(b__21721,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null));

var G__22422 = (i__21720 + (1));
i__21720 = G__22422;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21721),website_helpers$page_graph$index_categories_$_iter__21718(cljs.core.chunk_rest(s__21719__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21721),null);
}
} else {
var vec__21789 = cljs.core.first(s__21719__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21789,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21789,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c,(num_notes + i)], null),website_helpers$page_graph$index_categories_$_iter__21718(cljs.core.rest(s__21719__$2)));
}
} else {
return null;
}
...
var most_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21798_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__21798_SHARP_));
}),notes__$1));
var least_mod_num = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21800_SHARP_){
return cljs.core.count(new cljs.core.Keyword(null,"modification-unix-timestamps","modification-unix-timestamps",653432816).cljs$core$IFn$_invoke$arity$1(p1__21800_SHARP_));
}),notes__$1));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21969),website_helpers$page_graph$notes_to_graph_$_iter__21966(cljs.core.chunk_rest(s__21967__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21969),null);
}
} else {
var vec__22034 = cljs.core.first(s__21967__$2);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22034,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22034,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(0),new cljs.core.Keyword(null,"target","target",253001721),i,new cljs.core.Keyword(null,"value","value",305978217),(3)], null),website_helpers$page_graph$notes_to_graph_$_iter__21966(cljs.core.rest(s__21967__$2)));
}
} else {
return null;
}
