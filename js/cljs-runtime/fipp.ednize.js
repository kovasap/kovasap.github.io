...
var fipp$ednize$IEdn$_edn$dyn_44159 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_44159(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function fipp$ednize$edn_$_iter__44101(s__44102){
return (new cljs.core.LazySeq(null,(function (){
var s__44102__$1 = s__44102;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__44102__$1);
if(temp__5804__auto__){
var s__44102__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__44102__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__44102__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__44104 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__44103 = (0);
while(true){
if((i__44103 < size__5522__auto__)){
var k = cljs.core._nth(c__5521__auto__,i__44103);
cljs.core.chunk_append(b__44104,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__44174 = (i__44103 + (1));
i__44103 = G__44174;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44104),fipp$ednize$edn_$_iter__44101(cljs.core.chunk_rest(s__44102__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44104),null);
}
} else {
var k = cljs.core.first(s__44102__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__44101(cljs.core.rest(s__44102__$2)));
}
} else {
return null;
}
