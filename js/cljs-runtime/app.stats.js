...
return cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.identity,kixi.stats.core.r_squared((function (p1__120656_SHARP_){
return app.stats.compute_linear_estimate(linear_model,(var1.cljs$core$IFn$_invoke$arity$1 ? var1.cljs$core$IFn$_invoke$arity$1(p1__120656_SHARP_) : var1.call(null,p1__120656_SHARP_)));
}),var2),data);
}
});
/**
...
var len__4864__auto___120661 = arguments.length;
var i__4865__auto___120662 = (0);
while(true){
if((i__4865__auto___120662 < len__4864__auto___120661)){
args__4870__auto__.push((arguments[i__4865__auto___120662]));

var G__120663 = (i__4865__auto___120662 + (1));
i__4865__auto___120662 = G__120663;
continue;
} else {
}
break;
...
return cljs.core.every_QMARK_((function (p1__120657_SHARP_){
return cljs.core.not(isNaN((p1__120657_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__120657_SHARP_.cljs$core$IFn$_invoke$arity$1(datum) : p1__120657_SHARP_.call(null,datum))));
}),ks);
}),data);
}));
...
/** @this {Function} */
(app.stats.filter_missing.cljs$lang$applyTo = (function (seq120658){
var G__120659 = cljs.core.first(seq120658);
var seq120658__$1 = cljs.core.next(seq120658);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__120659,seq120658__$1);
}));
...
var cleaned_data = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__120660_SHARP_){
return cljs.core.select_keys(p1__120660_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"timestamp","timestamp",579478971),var1,var2], null));
