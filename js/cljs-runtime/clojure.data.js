...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__26747){
...
var clojure$data$EqualityPartition$equality_partition$dyn_27050 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27050(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27062 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27062(a,b);
}
});
...
var fexpr__26924 = (function (){var G__26925 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26925__$1)].join('')));

}
})();
return (fexpr__26924.cljs$core$IFn$_invoke$arity$2 ? fexpr__26924.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__26924.call(null,a,b));
}));
/**
