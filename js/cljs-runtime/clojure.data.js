...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__27436){
...
var vec__27440 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27440,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27440,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27440,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_27547 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27547(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27558 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27558(a,b);
}
});
...
var fexpr__27500 = (function (){var G__27501 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27501__$1)].join('')));

}
})();
return (fexpr__27500.cljs$core$IFn$_invoke$arity$2 ? fexpr__27500.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__27500.call(null,a,b));
}));
/**
