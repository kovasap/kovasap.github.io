...
var o9885 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9885["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9886 = temp__5718__auto____$1;
return (o9886["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8997__auto__ = f;
return (o__8997__auto__["toString"]).call(o__8997__auto__);
} else {
return "";
}
}catch (e9887){var _ = e9887;
return "";
}});
...
try{var o__8997__auto___9889 = t;
(o__8997__auto___9889["cljs$lang$ctorPrWriter"]).call(o__8997__auto___9889,t,writer);
}catch (e9888){var __9890 = e9888;
}
...
var char_code = (function (){var o__8997__auto__ = (new String(char$));
return (o__8997__auto__["charCodeAt"]).call(o__8997__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8997__auto__ = String;
return (o__8997__auto__["fromCharCode"]).call(o__8997__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9891 = num_code;
switch (G__9891) {
case (1):
return (185);
...
var o__8997__auto__ = String;
return (o__8997__auto__["fromCharCode"]).call(o__8997__auto__,superscript_code);
});
/**
...
}catch (e9893){var _e__9004__auto__ = e9893;
return false;
}})())){
...
var vec__9894 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9894,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o9897 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9897["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9898 = temp__5718__auto____$1;
return (o9898["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9901){
var vec__9902 = p__9901;
var ns_detector = cljs.core.nth.call(null,vec__9902,(0),null);
...
var G__9908 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9909 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9908;
remaining_tokens = G__9909;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9899){
var G__9900 = cljs.core.first.call(null,seq9899);
var seq9899__$1 = cljs.core.next.call(null,seq9899);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9900,seq9899__$1);
});
...
var vec__9913 = cljs.core.split_with.call(null,(function (p1__9912_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9912_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9913,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9913,(1),null);
...
var vec__9916 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9916,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9916,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9919 = cljs.core.rest.call(null,remaining_tokens);
var G__9920 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9919;
name_tokens = G__9920;
continue;
} else {
...
var vec__9923 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9923,(0),null);
var arity = cljs.core.nth.call(null,vec__9923,(1),null);
var vec__9926 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9926,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9926,(1),null);
var vec__9929 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9929,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9929,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9929,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9929,(3),null);
...
var vec__9935 = result;
var munged_ns = cljs.core.nth.call(null,vec__9935,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9935,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9935,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9935,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9935,(4),null);
var arity = cljs.core.nth.call(null,vec__9935,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__9939 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__9939,(0),null);
var args = cljs.core.nth.call(null,vec__9939,(1),null);
var vec__9942 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9942,(0),null);
var name = cljs.core.nth.call(null,vec__9942,(1),null);
...
var G__9945 = (arity + (1));
var G__9946 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9947){
var vec__9948 = p__9947;
var arity = cljs.core.nth.call(null,vec__9948,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9948,(1),null);
...
return cljs.core.get.call(null,arities,p1__9951_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__9952_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___9959 = arguments.length;
var i__4532__auto___9960 = (0);
while(true){
if((i__4532__auto___9960 < len__4531__auto___9959)){
args__4534__auto__.push((arguments[i__4532__auto___9960]));

var G__9961 = (i__4532__auto___9960 + (1));
i__4532__auto___9960 = G__9961;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9955){
var vec__9956 = p__9955;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9956,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9953){
var G__9954 = cljs.core.first.call(null,seq9953);
var seq9953__$1 = cljs.core.next.call(null,seq9953);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9954,seq9953__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__9964__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9964__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9964__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9964__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9965 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9965,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9965,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9965,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9965,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9965,(4),null);
var arity = cljs.core.nth.call(null,vec__9965,(5),null);
...
var o__8997__auto__ = f;
return (o__8997__auto__["getBasis"]).call(o__8997__auto__);
});
/**
...
}catch (e9969){var _e__9004__auto__ = e9969;
...
var G__9970 = (obj[cljs.core.first.call(null,path)]);
var G__9971 = cljs.core.rest.call(null,path);
obj = G__9970;
path = G__9971;
continue;
} else {
...
return (function (accum,p__9972){
var vec__9973 = p__9972;
var bit = cljs.core.nth.call(null,vec__9973,(0),null);
var protocol = cljs.core.nth.call(null,vec__9973,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9976){
var vec__9977 = p__9976;
var ns = cljs.core.nth.call(null,vec__9977,(0),null);
var name = cljs.core.nth.call(null,vec__9977,(1),null);
var selector = cljs.core.nth.call(null,vec__9977,(2),null);
...
return (function (p__9981){
var vec__9982 = p__9981;
var munged_name = cljs.core.nth.call(null,vec__9982,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9982,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__9982,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__9980_SHARP_){
return (obj[cljs.core.first.call(null,p1__9980_SHARP_)]);
});})(name,sorted_matches,vec__9982,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
