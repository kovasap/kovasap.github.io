...
var G__11089 = devtools.prefs.pref.call(null,v);
v = G__11089;
continue;
} else {
return v;
...
}catch (e11092){var _e__10560__auto__ = e11092;
return false;
}})();
...
}catch (e11096){var _e__10560__auto__ = e11096;
return false;
}})();
...
}catch (e11098){var _e__10560__auto__ = e11098;
return false;
}}
}
});
...
var vec__11100 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11100,(0),null);
var name = cljs.core.nth.call(null,vec__11100,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11103_SHARP_);
}),template);
});
