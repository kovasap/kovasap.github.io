...
var o10987 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10987["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10988 = temp__5718__auto____$1;
return (o10988["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10553__auto__ = f;
return (o__10553__auto__["toString"]).call(o__10553__auto__);
} else {
return "";
}
}catch (e10989){var _ = e10989;
return "";
}});
...
try{var o__10553__auto___10991 = t;
(o__10553__auto___10991["cljs$lang$ctorPrWriter"]).call(o__10553__auto___10991,t,writer);
}catch (e10990){var __10992 = e10990;
}
...
var char_code = (function (){var o__10553__auto__ = (new String(char$));
return (o__10553__auto__["charCodeAt"]).call(o__10553__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10553__auto__ = String;
return (o__10553__auto__["fromCharCode"]).call(o__10553__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10993 = num_code;
switch (G__10993) {
case (1):
return (185);
...
var o__10553__auto__ = String;
return (o__10553__auto__["fromCharCode"]).call(o__10553__auto__,superscript_code);
});
/**
...
}catch (e10995){var _e__10560__auto__ = e10995;
return false;
}})())){
...
var vec__10996 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10996,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o10999 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10999["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o11000 = temp__5718__auto____$1;
return (o11000["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11003){
var vec__11004 = p__11003;
var ns_detector = cljs.core.nth.call(null,vec__11004,(0),null);
...
var G__11010 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11011 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11010;
remaining_tokens = G__11011;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11001){
...
var vec__11015 = cljs.core.split_with.call(null,(function (p1__11014_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11014_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11015,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11015,(1),null);
...
var vec__11018 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11018,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11018,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11021 = cljs.core.rest.call(null,remaining_tokens);
var G__11022 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11021;
name_tokens = G__11022;
continue;
} else {
...
var vec__11025 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11025,(0),null);
var arity = cljs.core.nth.call(null,vec__11025,(1),null);
var vec__11028 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11028,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11028,(1),null);
var vec__11031 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11031,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11031,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11031,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11031,(3),null);
...
var vec__11037 = result;
var munged_ns = cljs.core.nth.call(null,vec__11037,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11037,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11037,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11037,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11037,(4),null);
var arity = cljs.core.nth.call(null,vec__11037,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__11041 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__11041,(0),null);
var args = cljs.core.nth.call(null,vec__11041,(1),null);
var vec__11044 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__11047 = (arity + (1));
var G__11048 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11049){
var vec__11050 = p__11049;
var arity = cljs.core.nth.call(null,vec__11050,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11050,(1),null);
...
return cljs.core.get.call(null,arities,p1__11053_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__11054_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11057){
var vec__11058 = p__11057;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11058,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11055){
var G__11056 = cljs.core.first.call(null,seq11055);
var seq11055__$1 = cljs.core.next.call(null,seq11055);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11056,seq11055__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__11066__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11066__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11066__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11066__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11067 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11067,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11067,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11067,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11067,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11067,(4),null);
var arity = cljs.core.nth.call(null,vec__11067,(5),null);
...
var o__10553__auto__ = f;
return (o__10553__auto__["getBasis"]).call(o__10553__auto__);
});
/**
...
}catch (e11071){var _e__10560__auto__ = e11071;
...
var G__11072 = (obj[cljs.core.first.call(null,path)]);
var G__11073 = cljs.core.rest.call(null,path);
obj = G__11072;
path = G__11073;
continue;
} else {
...
return (function (accum,p__11074){
var vec__11075 = p__11074;
var bit = cljs.core.nth.call(null,vec__11075,(0),null);
var protocol = cljs.core.nth.call(null,vec__11075,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11078){
var vec__11079 = p__11078;
var ns = cljs.core.nth.call(null,vec__11079,(0),null);
var name = cljs.core.nth.call(null,vec__11079,(1),null);
var selector = cljs.core.nth.call(null,vec__11079,(2),null);
...
return (function (p__11083){
var vec__11084 = p__11083;
var munged_name = cljs.core.nth.call(null,vec__11084,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11084,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__11084,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__11082_SHARP_){
return (obj[cljs.core.first.call(null,p1__11082_SHARP_)]);
});})(name,sorted_matches,vec__11084,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
