...
var vec__10003 = axis;
var a_x = cljs.core.nth.call(null,vec__10003,(0),null);
var a_y = cljs.core.nth.call(null,vec__10003,(1),null);
var a_z = cljs.core.nth.call(null,vec__10003,(2),null);
var vec__10006 = v;
var x = cljs.core.nth.call(null,vec__10006,(0),null);
var y = cljs.core.nth.call(null,vec__10006,(1),null);
var z = cljs.core.nth.call(null,vec__10006,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__10009,p__10010){
var vec__10011 = p__10009;
var u1 = cljs.core.nth.call(null,vec__10011,(0),null);
var u2 = cljs.core.nth.call(null,vec__10011,(1),null);
var u3 = cljs.core.nth.call(null,vec__10011,(2),null);
var vec__10014 = p__10010;
var v1 = cljs.core.nth.call(null,vec__10014,(0),null);
var v2 = cljs.core.nth.call(null,vec__10014,(1),null);
var v3 = cljs.core.nth.call(null,vec__10014,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__10017_SHARP_){
return (p1__10017_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__10018_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__10019_SHARP_,angle_lr),angle_ud);
...
var map__10021 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__10021__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__10021__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5718__auto__ = (function (){var pred__10023 = cljs.core._EQ_;
var expr__10024 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__10023.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__10024))){
return straight;
} else {
if(cljs.core.truth_(pred__10023.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__10024))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__10023.call(null,quil.middlewares.navigation_3d.space,expr__10024))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__10023.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__10024))){
return up;
} else {
if(cljs.core.truth_(pred__10023.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__10024))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__10023.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__10024))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5718__auto__,map__10021,map__10021__$1,up,straight){
return (function (p1__10020_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__10020_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5718__auto__,map__10021,map__10021__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__10026_SHARP_);
});})(initial_state))
);
});
/**
...
var map__10027_10038 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__10027_10039__$1 = ((((!((map__10027_10038 == null)))?(((((map__10027_10038.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10027_10038.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10027_10038):map__10027_10038);
var vec__10028_10040 = cljs.core.get.call(null,map__10027_10039__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_10041 = cljs.core.nth.call(null,vec__10028_10040,(0),null);
var c_y_10042 = cljs.core.nth.call(null,vec__10028_10040,(1),null);
var c_z_10043 = cljs.core.nth.call(null,vec__10028_10040,(2),null);
var vec__10031_10044 = cljs.core.get.call(null,map__10027_10039__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_10045 = cljs.core.nth.call(null,vec__10031_10044,(0),null);
var u_y_10046 = cljs.core.nth.call(null,vec__10031_10044,(1),null);
var u_z_10047 = cljs.core.nth.call(null,vec__10031_10044,(2),null);
var vec__10034_10048 = cljs.core.get.call(null,map__10027_10039__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_10049 = cljs.core.nth.call(null,vec__10034_10048,(0),null);
var p_y_10050 = cljs.core.nth.call(null,vec__10034_10048,(1),null);
var p_z_10051 = cljs.core.nth.call(null,vec__10034_10048,(2),null);
quil.core.camera.call(null,p_x_10049,p_y_10050,p_z_10051,(p_x_10049 + c_x_10041),(p_y_10050 + c_y_10042),(p_z_10051 + c_z_10043),u_x_10045,u_y_10046,u_z_10047);
