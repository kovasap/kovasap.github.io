...
var G__11087 = devtools.prefs.pref.call(null,v);
v = G__11087;
continue;
} else {
return v;
...
}catch (e11090){var _e__10558__auto__ = e11090;
return false;
}})();
...
}catch (e11094){var _e__10558__auto__ = e11094;
return false;
}})();
...
}catch (e11096){var _e__10558__auto__ = e11096;
return false;
}}
}
});
...
var vec__11098 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11098,(0),null);
var name = cljs.core.nth.call(null,vec__11098,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11101_SHARP_);
}),template);
});
