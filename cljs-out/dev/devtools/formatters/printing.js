...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11113){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11119_SHARP_){
return !((cljs.core.meta.call(null,p1__11119_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__11120__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11124){var _e__10558__auto__ = e11124;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e11126){var _e__10558__auto__ = e11126;
return false;
}}
})())){
...
var _STAR_current_state_STAR_11128 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__11129 = opts;
...
var markup_db = cljs.core.get.call(null,map__11129__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_11128;
}});
...
;
var temp__5718__auto___11133 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___11133)){
var managed_print_level_11134 = temp__5718__auto___11133;
var _STAR_print_level_STAR_11132_11135 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_11134;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_11132_11135,managed_print_level_11134,temp__5718__auto___11133,writer,opts,job_fn){
return (function (p1__11131_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__11131_SHARP_,null);
});})(_STAR_print_level_STAR_11132_11135,managed_print_level_11134,temp__5718__auto___11133,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_11132_11135;
}} else {
job_fn.call(null);
}
