...
var o10985 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10985["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10986 = temp__5718__auto____$1;
return (o10986["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10551__auto__ = f;
return (o__10551__auto__["toString"]).call(o__10551__auto__);
} else {
return "";
}
}catch (e10987){var _ = e10987;
return "";
}});
...
try{var o__10551__auto___10989 = t;
(o__10551__auto___10989["cljs$lang$ctorPrWriter"]).call(o__10551__auto___10989,t,writer);
}catch (e10988){var __10990 = e10988;
}
...
var char_code = (function (){var o__10551__auto__ = (new String(char$));
return (o__10551__auto__["charCodeAt"]).call(o__10551__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10551__auto__ = String;
return (o__10551__auto__["fromCharCode"]).call(o__10551__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10991 = num_code;
switch (G__10991) {
case (1):
return (185);
...
var o__10551__auto__ = String;
return (o__10551__auto__["fromCharCode"]).call(o__10551__auto__,superscript_code);
});
/**
...
}catch (e10993){var _e__10558__auto__ = e10993;
return false;
}})())){
...
var vec__10994 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10994,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o10997 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10997["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10998 = temp__5718__auto____$1;
return (o10998["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11001){
var vec__11002 = p__11001;
var ns_detector = cljs.core.nth.call(null,vec__11002,(0),null);
...
var G__11008 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11009 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11008;
remaining_tokens = G__11009;
continue;
}
}
break;
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11000,seq10999__$1);
});
...
var vec__11013 = cljs.core.split_with.call(null,(function (p1__11012_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11012_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11013,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11013,(1),null);
...
var vec__11016 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11016,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11016,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11019 = cljs.core.rest.call(null,remaining_tokens);
var G__11020 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11019;
name_tokens = G__11020;
continue;
} else {
...
var vec__11023 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11023,(0),null);
var arity = cljs.core.nth.call(null,vec__11023,(1),null);
var vec__11026 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11026,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11026,(1),null);
var vec__11029 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11029,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11029,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11029,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11029,(3),null);
...
var vec__11035 = result;
var munged_ns = cljs.core.nth.call(null,vec__11035,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11035,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11035,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11035,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11035,(4),null);
var arity = cljs.core.nth.call(null,vec__11035,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__11039 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__11039,(0),null);
var args = cljs.core.nth.call(null,vec__11039,(1),null);
var vec__11042 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11042,(0),null);
var name = cljs.core.nth.call(null,vec__11042,(1),null);
...
var G__11045 = (arity + (1));
var G__11046 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11047){
var vec__11048 = p__11047;
var arity = cljs.core.nth.call(null,vec__11048,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11048,(1),null);
...
return cljs.core.get.call(null,arities,p1__11051_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__11052_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___11059 = arguments.length;
var i__4532__auto___11060 = (0);
while(true){
if((i__4532__auto___11060 < len__4531__auto___11059)){
args__4534__auto__.push((arguments[i__4532__auto___11060]));

var G__11061 = (i__4532__auto___11060 + (1));
i__4532__auto___11060 = G__11061;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11055){
var vec__11056 = p__11055;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11056,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11053){
var G__11054 = cljs.core.first.call(null,seq11053);
var seq11053__$1 = cljs.core.next.call(null,seq11053);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11054,seq11053__$1);
});
...
var G__11062 = arg;
var G__11062__$1 = (((G__11062 instanceof cljs.core.Keyword))?G__11062.fqn:null);
switch (G__11062__$1) {
...
var map__11064 = options;
var map__11064__$1 = ((((!((map__11064 == null)))?(((((map__11064.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11064.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11064):map__11064);
var include_ns_QMARK_ = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11065 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11065,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11065,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11065,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11065,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11065,(4),null);
var arity = cljs.core.nth.call(null,vec__11065,(5),null);
...
var o__10551__auto__ = f;
return (o__10551__auto__["getBasis"]).call(o__10551__auto__);
});
/**
...
}catch (e11069){var _e__10558__auto__ = e11069;
...
var G__11070 = (obj[cljs.core.first.call(null,path)]);
var G__11071 = cljs.core.rest.call(null,path);
obj = G__11070;
path = G__11071;
continue;
} else {
...
return (function (accum,p__11072){
var vec__11073 = p__11072;
var bit = cljs.core.nth.call(null,vec__11073,(0),null);
var protocol = cljs.core.nth.call(null,vec__11073,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11076){
...
var selector = cljs.core.nth.call(null,vec__11077,(2),null);
...
return (function (p__11081){
var vec__11082 = p__11081;
var munged_name = cljs.core.nth.call(null,vec__11082,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11082,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__11082,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__11080_SHARP_){
return (obj[cljs.core.first.call(null,p1__11080_SHARP_)]);
});})(name,sorted_matches,vec__11082,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
