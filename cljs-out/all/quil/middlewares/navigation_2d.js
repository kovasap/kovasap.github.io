...
return cljs.core.merge.call(null,initial_state,p1__10036_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_10037 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_10038 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_10037);
var pos_10039 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_10037);
quil.core.scale.call(null,zoom_10038);

var tr__9940__auto___10040 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_10038) - cljs.core.first.call(null,pos_10039)),(((quil.core.height.call(null) / (2)) / zoom_10038) - cljs.core.second.call(null,pos_10039))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__9940__auto___10040);
