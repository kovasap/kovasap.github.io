...
var G__11138 = devtools.prefs.pref.call(null,v);
v = G__11138;
continue;
} else {
return v;
...
}catch (e11141){var _e__10155__auto__ = e11141;
return false;
}})();
...
}catch (e11145){var _e__10155__auto__ = e11145;
return false;
}})();
...
}catch (e11147){var _e__10155__auto__ = e11147;
return false;
}}
}
});
...
var vec__11149 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11149,(0),null);
var name = cljs.core.nth.call(null,vec__11149,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11152_SHARP_);
}),template);
});
