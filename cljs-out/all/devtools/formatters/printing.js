...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11164){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11170_SHARP_){
return !((cljs.core.meta.call(null,p1__11170_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__11171__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11175){var _e__10155__auto__ = e11175;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e11177){var _e__10155__auto__ = e11177;
return false;
}}
})())){
...
var _STAR_current_state_STAR_11179 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__11180 = opts;
var map__11180__$1 = ((((!((map__11180 == null)))?(((((map__11180.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11180.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11180):map__11180);
var markup_db = cljs.core.get.call(null,map__11180__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_11179;
}});
...
;
var temp__5718__auto___11184 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___11184)){
var managed_print_level_11185 = temp__5718__auto___11184;
var _STAR_print_level_STAR_11183_11186 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_11185;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_11183_11186,managed_print_level_11185,temp__5718__auto___11184,writer,opts,job_fn){
return (function (p1__11182_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__11182_SHARP_,null);
});})(_STAR_print_level_STAR_11183_11186,managed_print_level_11185,temp__5718__auto___11184,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_11183_11186;
}} else {
job_fn.call(null);
}
